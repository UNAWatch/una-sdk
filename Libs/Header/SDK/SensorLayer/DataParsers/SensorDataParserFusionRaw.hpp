/**
 ******************************************************************************
 * @file    SensorDataParserFusionRaw.hpp
 * @date    23-March-2026
 * @author  Oleksandr Tymoshenko <oleksandr.tymoshenko@droid-technologies.com>
 * @brief   Sensor data parser for FUSION_RAW sensor
 *
 ******************************************************************************
 */

#ifndef __SENSOR_DATA_PARSER_FUSION_RAW_HPP
#define __SENSOR_DATA_PARSER_FUSION_RAW_HPP
...
namespace SDK
{
    namespace SensorDataParser
    {
        ...
        public:
             ...
             * @param data Sensor data view containing 6 int16_t values
             */
            FusionRaw(const SDK::Sensor::DataView data) : mData(data) {}
...
#endif /* __SENSOR_DATA_PARSER_FUSION_RAW_HPP */
