...
// Profile Version = 21.202.0Release+Custom
...
#if !defined(FIT_RELEASE_H)
#define FIT_RELEASE_H
...
#define FIT_MESG_NUM_NAP_EVENT                                                  (FIT_CAST(FIT_MESG_NUM, 412))
...
#define FIT_SPORT_SHOOTING                                                      (FIT_CAST(FIT_SPORT, 56)) // Sport Shooting bits, set here for sport_bits alignment
#define FIT_SPORT_WINTER_SPORT                                                  (FIT_CAST(FIT_SPORT, 58))
#define FIT_SPORT_GRINDING                                                      (FIT_CAST(FIT_SPORT, 59)) // Sailing position, operating manual winches to power boat controls
#define FIT_SPORT_HIIT                                                          (FIT_CAST(FIT_SPORT, 62))
#define FIT_SPORT_VIDEO_GAMING                                                  (FIT_CAST(FIT_SPORT, 63))
...
#define FIT_SPORT_PARA_SPORT                                                    (FIT_CAST(FIT_SPORT, 68))
#define FIT_SPORT_DISC_GOLF                                                     (FIT_CAST(FIT_SPORT, 69))
#define FIT_SPORT_TEAM_SPORT                                                    (FIT_CAST(FIT_SPORT, 70))
...
#define FIT_SPORT_WATER_SPORT                                                   (FIT_CAST(FIT_SPORT, 78))
#define FIT_SPORT_ARCHERY                                                       (FIT_CAST(FIT_SPORT, 79))
#define FIT_SPORT_MIXED_MARTIAL_ARTS                                            (FIT_CAST(FIT_SPORT, 80))
#define FIT_SPORT_MOTOR_SPORTS                                                  (FIT_CAST(FIT_SPORT, 81))
...
#define FIT_SPORT_POOL_APNEA                                                    (FIT_CAST(FIT_SPORT, 85))
#define FIT_SPORT_MOBILITY                                                      (FIT_CAST(FIT_SPORT, 86))
#define FIT_SPORT_GEOCACHING                                                    (FIT_CAST(FIT_SPORT, 87))
#define FIT_SPORT_CANOEING                                                      (FIT_CAST(FIT_SPORT, 88))
#define FIT_SPORT_ALL                                                           (FIT_CAST(FIT_SPORT, 254)) // All is for goals only to include all sports.
#define FIT_SPORT_COUNT                                                         82
...
#define FIT_SUB_SPORT_CCR_DIVING                                                (FIT_CAST(FIT_SUB_SPORT, 63)) // Diving w/ closed circuit rebreather
#define FIT_SUB_SPORT_SAIL_RACE                                                 (FIT_CAST(FIT_SUB_SPORT, 65)) // Sailing
#define FIT_SUB_SPORT_EXPEDITION                                                (FIT_CAST(FIT_SUB_SPORT, 66)) // Generic
...
#define FIT_SUB_SPORT_INDOOR_GRINDING                                           (FIT_CAST(FIT_SUB_SPORT, 71)) // Sailing position, operating manual winches to power boat controls
#define FIT_SUB_SPORT_HUNTING_WITH_DOGS                                         (FIT_CAST(FIT_SUB_SPORT, 72)) // Hunting
...
#define FIT_SUB_SPORT_ESPORT                                                    (FIT_CAST(FIT_SUB_SPORT, 77)) // Video Gaming, Cycling, etc.
#define FIT_SUB_SPORT_TRIATHLON                                                 (FIT_CAST(FIT_SUB_SPORT, 78)) // Multisport
#define FIT_SUB_SPORT_DUATHLON                                                  (FIT_CAST(FIT_SUB_SPORT, 79)) // Multisport
#define FIT_SUB_SPORT_BRICK                                                     (FIT_CAST(FIT_SUB_SPORT, 80)) // Multisport
#define FIT_SUB_SPORT_SWIM_RUN                                                  (FIT_CAST(FIT_SUB_SPORT, 81)) // Multisport
#define FIT_SUB_SPORT_ADVENTURE_RACE                                            (FIT_CAST(FIT_SUB_SPORT, 82)) // Multisport
#define FIT_SUB_SPORT_TRUCKER_WORKOUT                                           (FIT_CAST(FIT_SUB_SPORT, 83)) // DEZL trucker workout training sport
...
#define FIT_SUB_SPORT_FIELD                                                     (FIT_CAST(FIT_SUB_SPORT, 90)) // Hockey
#define FIT_SUB_SPORT_ICE                                                       (FIT_CAST(FIT_SUB_SPORT, 91)) // Hockey
#define FIT_SUB_SPORT_ULTIMATE                                                  (FIT_CAST(FIT_SUB_SPORT, 92)) // Disc
#define FIT_SUB_SPORT_PLATFORM                                                  (FIT_CAST(FIT_SUB_SPORT, 93)) // Racket
#define FIT_SUB_SPORT_SQUASH                                                    (FIT_CAST(FIT_SUB_SPORT, 94)) // Racket
#define FIT_SUB_SPORT_BADMINTON                                                 (FIT_CAST(FIT_SUB_SPORT, 95)) // Racket
#define FIT_SUB_SPORT_RACQUETBALL                                               (FIT_CAST(FIT_SUB_SPORT, 96)) // Racket
#define FIT_SUB_SPORT_TABLE_TENNIS                                              (FIT_CAST(FIT_SUB_SPORT, 97)) // Racket
#define FIT_SUB_SPORT_OVERLAND                                                  (FIT_CAST(FIT_SUB_SPORT, 98))
#define FIT_SUB_SPORT_TROLLING_MOTOR                                            (FIT_CAST(FIT_SUB_SPORT, 99)) // Generic
...
#define FIT_SUB_SPORT_DYNAMIC_APNEA                                             (FIT_CAST(FIT_SUB_SPORT, 121))
#define FIT_SUB_SPORT_ENDURO                                                    (FIT_CAST(FIT_SUB_SPORT, 123)) // Cycling
#define FIT_SUB_SPORT_RUCKING                                                   (FIT_CAST(FIT_SUB_SPORT, 124)) // Hiking
#define FIT_SUB_SPORT_RALLY                                                     (FIT_CAST(FIT_SUB_SPORT, 125)) // Motor sports
#define FIT_SUB_SPORT_POOL_TRIATHLON                                            (FIT_CAST(FIT_SUB_SPORT, 126)) // Multisport
#define FIT_SUB_SPORT_E_BIKE_ENDURO                                             (FIT_CAST(FIT_SUB_SPORT, 127)) // Cycling
#define FIT_SUB_SPORT_ALL                                                       (FIT_CAST(FIT_SUB_SPORT, 254))
#define FIT_SUB_SPORT_COUNT                                                     112
...
#define FIT_MANUFACTURER_ZEPP                                                   (FIT_CAST(FIT_MANUFACTURER, 339))
#define FIT_MANUFACTURER_PELOTON                                                (FIT_CAST(FIT_MANUFACTURER, 340))
#define FIT_MANUFACTURER_CARV                                                   (FIT_CAST(FIT_MANUFACTURER, 341))
#define FIT_MANUFACTURER_TISSOT                                                 (FIT_CAST(FIT_MANUFACTURER, 342))
#define FIT_MANUFACTURER_REAL_VELO                                              (FIT_CAST(FIT_MANUFACTURER, 345))
#define FIT_MANUFACTURER_WETECH                                                 (FIT_CAST(FIT_MANUFACTURER, 346))
#define FIT_MANUFACTURER_JESPR                                                  (FIT_CAST(FIT_MANUFACTURER, 347))
#define FIT_MANUFACTURER_HUAWEI                                                 (FIT_CAST(FIT_MANUFACTURER, 348))
#define FIT_MANUFACTURER_GOTOES                                                 (FIT_CAST(FIT_MANUFACTURER, 349))
#define FIT_MANUFACTURER_CADENCE_APP                                            (FIT_CAST(FIT_MANUFACTURER, 350))
#define FIT_MANUFACTURER_ACTIGRAPHCORP                                          (FIT_CAST(FIT_MANUFACTURER, 5759))
#define FIT_MANUFACTURER_COUNT                                                  243
...
#define FIT_GARMIN_PRODUCT_APPROACH_J1                                          (FIT_CAST(FIT_GARMIN_PRODUCT, 4825))
...
#define FIT_GARMIN_PRODUCT_COUNT                                                475
...
typedef FIT_ENUM FIT_NAP_PERIOD_FEEDBACK;
#define FIT_NAP_PERIOD_FEEDBACK_INVALID                                         FIT_ENUM_INVALID
#define FIT_NAP_PERIOD_FEEDBACK_NONE                                            (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 0))
#define FIT_NAP_PERIOD_FEEDBACK_MULTIPLE_NAPS_DURING_DAY                        (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 1))
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_IDEAL_TIMING_IDEAL_DURATION              (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 2))
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_IDEAL_TIMING_LONG_DURATION               (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 3))
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_LATE_TIMING_IDEAL_DURATION               (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 4))
#define FIT_NAP_PERIOD_FEEDBACK_JETLAG_LATE_TIMING_LONG_DURATION                (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 5))
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_IDEAL_DURATION_LOW_NEED            (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 6))
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_IDEAL_DURATION_HIGH_NEED           (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 7))
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_LONG_DURATION_LOW_NEED             (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 8))
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_TIMING_LONG_DURATION_HIGH_NEED            (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 9))
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_IDEAL_DURATION_LOW_NEED             (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 10))
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_IDEAL_DURATION_HIGH_NEED            (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 11))
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_LONG_DURATION_LOW_NEED              (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 12))
#define FIT_NAP_PERIOD_FEEDBACK_LATE_TIMING_LONG_DURATION_HIGH_NEED             (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 13))
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_DURATION_LOW_NEED                         (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 14))
#define FIT_NAP_PERIOD_FEEDBACK_IDEAL_DURATION_HIGH_NEED                        (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 15))
#define FIT_NAP_PERIOD_FEEDBACK_LONG_DURATION_LOW_NEED                          (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 16))
#define FIT_NAP_PERIOD_FEEDBACK_LONG_DURATION_HIGH_NEED                         (FIT_CAST(FIT_NAP_PERIOD_FEEDBACK, 17))
#define FIT_NAP_PERIOD_FEEDBACK_COUNT                                           18

typedef FIT_ENUM FIT_NAP_SOURCE;
#define FIT_NAP_SOURCE_INVALID                                                  FIT_ENUM_INVALID
#define FIT_NAP_SOURCE_AUTOMATIC                                                (FIT_CAST(FIT_NAP_SOURCE, 0))
#define FIT_NAP_SOURCE_MANUAL_DEVICE                                            (FIT_CAST(FIT_NAP_SOURCE, 1))
#define FIT_NAP_SOURCE_MANUAL_GC                                                (FIT_CAST(FIT_NAP_SOURCE, 2))
#define FIT_NAP_SOURCE_COUNT                                                    3
...
#define FIT_MESG_SIZE       340
#define FIT_MESG_DEF_SIZE   479
...
// file_id message
#define FIT_FILE_ID_MESG_SIZE                                                   16
#define FIT_FILE_ID_MESG_DEF_SIZE                                               26
#define FIT_FILE_ID_MESG_PRODUCT_NAME_COUNT                                     1
...
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 253))
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_SYSTEM_TIMESTAMP (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 1))
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_LOCAL_TIMESTAMP (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 3))
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_FRACTIONAL_TIMESTAMP (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 0))
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_FRACTIONAL_SYSTEM_TIMESTAMP (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 2))
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 4))
#define FIT_TIMESTAMP_CORRELATION_FIELD_NUM_SYSTEM_TIMESTAMP_MS (FIT_CAST(FIT_TIMESTAMP_CORRELATION_FIELD_NUM, 5))
...
// software message
#define FIT_SOFTWARE_MESG_SIZE                                                  5
#define FIT_SOFTWARE_MESG_DEF_SIZE                                              14
#define FIT_SOFTWARE_MESG_PART_NUMBER_COUNT                                     1
...
#define FIT_CAPABILITIES_MESG_SIZE                                              10
#define FIT_CAPABILITIES_MESG_DEF_SIZE                                          17
#define FIT_CAPABILITIES_MESG_LANGUAGES_COUNT                                   1
...
#define FIT_FILE_CAPABILITIES_MESG_SIZE                                         11
#define FIT_FILE_CAPABILITIES_MESG_DEF_SIZE                                     23
#define FIT_FILE_CAPABILITIES_MESG_DIRECTORY_COUNT                              1
...
#define FIT_DEVICE_SETTINGS_FIELD_NUM_AUTO_ACTIVITY_DETECT (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 90))
...
#define FIT_DEVICE_SETTINGS_FIELD_NUM_LACTATE_THRESHOLD_AUTODETECT_ENABLED (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 80))
#define FIT_DEVICE_SETTINGS_FIELD_NUM_BLE_AUTO_UPLOAD_ENABLED (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 86))
#define FIT_DEVICE_SETTINGS_FIELD_NUM_AUTO_SYNC_FREQUENCY (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 89))
#define FIT_DEVICE_SETTINGS_FIELD_NUM_NUMBER_OF_SCREENS (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 94))
#define FIT_DEVICE_SETTINGS_FIELD_NUM_SMART_NOTIFICATION_DISPLAY_ORIENTATION (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 95))
#define FIT_DEVICE_SETTINGS_FIELD_NUM_TAP_INTERFACE (FIT_CAST(FIT_DEVICE_SETTINGS_FIELD_NUM, 134))
...
#define FIT_USER_PROFILE_MESG_SIZE                                              48
#define FIT_USER_PROFILE_MESG_DEF_SIZE                                          92
#define FIT_USER_PROFILE_MESG_FRIENDLY_NAME_COUNT                               1
#define FIT_USER_PROFILE_MESG_GLOBAL_ID_COUNT                                   6

typedef struct
{
   FIT_LOCALTIME_INTO_DAY wake_time; // Typical wake time
   FIT_LOCALTIME_INTO_DAY sleep_time; // Typical bed time
   FIT_UINT32 dive_count; //
   FIT_MESSAGE_INDEX message_index; //
   ...
   FIT_DISPLAY_MEASURE depth_setting; //
} FIT_USER_PROFILE_MESG;

typedef FIT_UINT8 FIT_USER_PROFILE_FIELD_NUM;

#define FIT_USER_PROFILE_FIELD_NUM_WAKE_TIME (FIT_CAST(FIT_USER_PROFILE_FIELD_NUM, 28))
#define FIT_USER_PROFILE_FIELD_NUM_SLEEP_TIME (FIT_CAST(FIT_USER_PROFILE_FIELD_NUM, 29))
#define FIT_USER_PROFILE_FIELD_NUM_DIVE_COUNT (FIT_CAST(FIT_USER_PROFILE_FIELD_NUM, 49))
...
#define FIT_USER_PROFILE_FIELD_NUM_DEPTH_SETTING (FIT_CAST(FIT_USER_PROFILE_FIELD_NUM, 47))

typedef enum
{
   FIT_USER_PROFILE_MESG_WAKE_TIME,
   FIT_USER_PROFILE_MESG_SLEEP_TIME,
   FIT_USER_PROFILE_MESG_DIVE_COUNT,
   ...
   FIT_USER_PROFILE_MESG_DEPTH_SETTING,
...
#define FIT_BIKE_PROFILE_MESG_SIZE                                              44
#define FIT_BIKE_PROFILE_MESG_DEF_SIZE                                          101
#define FIT_BIKE_PROFILE_MESG_NAME_COUNT                                        1
...
#define FIT_CONNECTIVITY_MESG_SIZE                                              13
#define FIT_CONNECTIVITY_MESG_DEF_SIZE                                          44
#define FIT_CONNECTIVITY_MESG_NAME_COUNT                                        1
...
#define FIT_WATCHFACE_SETTINGS_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_WATCHFACE_SETTINGS_FIELD_NUM, 254))
#define FIT_WATCHFACE_SETTINGS_FIELD_NUM_MODE (FIT_CAST(FIT_WATCHFACE_SETTINGS_FIELD_NUM, 0))
#define FIT_WATCHFACE_SETTINGS_FIELD_NUM_LAYOUT (FIT_CAST(FIT_WATCHFACE_SETTINGS_FIELD_NUM, 1))
...
#define FIT_OHR_SETTINGS_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_OHR_SETTINGS_FIELD_NUM, 253))
#define FIT_OHR_SETTINGS_FIELD_NUM_ENABLED (FIT_CAST(FIT_OHR_SETTINGS_FIELD_NUM, 0))
...
// time_in_zone message
#define FIT_TIME_IN_ZONE_MESG_SIZE                                              37
#define FIT_TIME_IN_ZONE_MESG_DEF_SIZE                                          56
#define FIT_TIME_IN_ZONE_MESG_TIME_IN_HR_ZONE_COUNT                             1
#define FIT_TIME_IN_ZONE_MESG_TIME_IN_SPEED_ZONE_COUNT                          1
#define FIT_TIME_IN_ZONE_MESG_TIME_IN_CADENCE_ZONE_COUNT                        1
#define FIT_TIME_IN_ZONE_MESG_TIME_IN_POWER_ZONE_COUNT                          1
#define FIT_TIME_IN_ZONE_MESG_SPEED_ZONE_HIGH_BOUNDARY_COUNT                    1
#define FIT_TIME_IN_ZONE_MESG_POWER_ZONE_HIGH_BOUNDARY_COUNT                    1
#define FIT_TIME_IN_ZONE_MESG_HR_ZONE_HIGH_BOUNDARY_COUNT                       1
#define FIT_TIME_IN_ZONE_MESG_CADENCE_ZONE_HIGH_BONDARY_COUNT                   1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT32 time_in_hr_zone[FIT_TIME_IN_ZONE_MESG_TIME_IN_HR_ZONE_COUNT]; // 1000 * s + 0,
   FIT_UINT32 time_in_speed_zone[FIT_TIME_IN_ZONE_MESG_TIME_IN_SPEED_ZONE_COUNT]; // 1000 * s + 0,
   FIT_UINT32 time_in_cadence_zone[FIT_TIME_IN_ZONE_MESG_TIME_IN_CADENCE_ZONE_COUNT]; // 1000 * s + 0,
   FIT_UINT32 time_in_power_zone[FIT_TIME_IN_ZONE_MESG_TIME_IN_POWER_ZONE_COUNT]; // 1000 * s + 0,
   FIT_MESG_NUM reference_mesg; //
   FIT_MESSAGE_INDEX reference_index; //
   FIT_UINT16 speed_zone_high_boundary[FIT_TIME_IN_ZONE_MESG_SPEED_ZONE_HIGH_BOUNDARY_COUNT]; // 1000 * m/s + 0,
   FIT_UINT16 power_zone_high_boundary[FIT_TIME_IN_ZONE_MESG_POWER_ZONE_HIGH_BOUNDARY_COUNT]; // 1 * watts + 0,
   FIT_UINT16 functional_threshold_power; //
   FIT_UINT8 hr_zone_high_boundary[FIT_TIME_IN_ZONE_MESG_HR_ZONE_HIGH_BOUNDARY_COUNT]; // 1 * bpm + 0,
   FIT_UINT8 cadence_zone_high_bondary[FIT_TIME_IN_ZONE_MESG_CADENCE_ZONE_HIGH_BONDARY_COUNT]; // 1 * rpm + 0,
...
} FIT_TIME_IN_ZONE_MESG;

typedef FIT_UINT8 FIT_TIME_IN_ZONE_FIELD_NUM;

#define FIT_TIME_IN_ZONE_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 253))
#define FIT_TIME_IN_ZONE_FIELD_NUM_TIME_IN_HR_ZONE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 2))
#define FIT_TIME_IN_ZONE_FIELD_NUM_TIME_IN_SPEED_ZONE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 3))
#define FIT_TIME_IN_ZONE_FIELD_NUM_TIME_IN_CADENCE_ZONE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 4))
#define FIT_TIME_IN_ZONE_FIELD_NUM_TIME_IN_POWER_ZONE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 5))
#define FIT_TIME_IN_ZONE_FIELD_NUM_REFERENCE_MESG (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 0))
#define FIT_TIME_IN_ZONE_FIELD_NUM_REFERENCE_INDEX (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 1))
#define FIT_TIME_IN_ZONE_FIELD_NUM_SPEED_ZONE_HIGH_BOUNDARY (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 7))
#define FIT_TIME_IN_ZONE_FIELD_NUM_POWER_ZONE_HIGH_BOUNDARY (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 9))
#define FIT_TIME_IN_ZONE_FIELD_NUM_FUNCTIONAL_THRESHOLD_POWER (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 15))
#define FIT_TIME_IN_ZONE_FIELD_NUM_HR_ZONE_HIGH_BOUNDARY (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 6))
#define FIT_TIME_IN_ZONE_FIELD_NUM_CADENCE_ZONE_HIGH_BONDARY (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 8))
#define FIT_TIME_IN_ZONE_FIELD_NUM_HR_CALC_TYPE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 10))
#define FIT_TIME_IN_ZONE_FIELD_NUM_MAX_HEART_RATE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 11))
#define FIT_TIME_IN_ZONE_FIELD_NUM_RESTING_HEART_RATE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 12))
#define FIT_TIME_IN_ZONE_FIELD_NUM_THRESHOLD_HEART_RATE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 13))
#define FIT_TIME_IN_ZONE_FIELD_NUM_PWR_CALC_TYPE (FIT_CAST(FIT_TIME_IN_ZONE_FIELD_NUM, 14))

typedef enum
{
   FIT_TIME_IN_ZONE_MESG_TIMESTAMP,
   FIT_TIME_IN_ZONE_MESG_TIME_IN_HR_ZONE,
   FIT_TIME_IN_ZONE_MESG_TIME_IN_SPEED_ZONE,
   FIT_TIME_IN_ZONE_MESG_TIME_IN_CADENCE_ZONE,
   FIT_TIME_IN_ZONE_MESG_TIME_IN_POWER_ZONE,
   FIT_TIME_IN_ZONE_MESG_REFERENCE_MESG,
   FIT_TIME_IN_ZONE_MESG_REFERENCE_INDEX,
   FIT_TIME_IN_ZONE_MESG_SPEED_ZONE_HIGH_BOUNDARY,
   FIT_TIME_IN_ZONE_MESG_POWER_ZONE_HIGH_BOUNDARY,
   FIT_TIME_IN_ZONE_MESG_FUNCTIONAL_THRESHOLD_POWER,
   FIT_TIME_IN_ZONE_MESG_HR_ZONE_HIGH_BOUNDARY,
   FIT_TIME_IN_ZONE_MESG_CADENCE_ZONE_HIGH_BONDARY,
   FIT_TIME_IN_ZONE_MESG_HR_CALC_TYPE,
   FIT_TIME_IN_ZONE_MESG_MAX_HEART_RATE,
   FIT_TIME_IN_ZONE_MESG_RESTING_HEART_RATE,
   FIT_TIME_IN_ZONE_MESG_THRESHOLD_HEART_RATE,
   FIT_TIME_IN_ZONE_MESG_PWR_CALC_TYPE,
   FIT_TIME_IN_ZONE_MESG_FIELDS
} FIT_TIME_IN_ZONE_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_TIME_IN_ZONE_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_TIME_IN_ZONE_MESG_DEF;
...
// sport message
#define FIT_SPORT_MESG_SIZE                                                     3
#define FIT_SPORT_MESG_DEF_SIZE                                                 14
#define FIT_SPORT_MESG_NAME_COUNT                                               1
...
#define FIT_CADENCE_ZONE_MESG_SIZE                                              4
#define FIT_CADENCE_ZONE_MESG_DEF_SIZE                                          14
#define FIT_CADENCE_ZONE_MESG_NAME_COUNT                                        1
...
#define FIT_TRAINING_SETTINGS_MESG_SIZE                                         14
#define FIT_TRAINING_SETTINGS_MESG_DEF_SIZE                                     17

typedef struct
{
   FIT_UINT32 target_distance; // 100 * m + 0,
   FIT_UINT32 target_time; // 1 * s + 0,
   FIT_UINT32 precise_target_speed; // 1000000 * m/s + 0, A more precise target speed field
...
#define FIT_TRAINING_SETTINGS_FIELD_NUM_PRECISE_TARGET_SPEED (FIT_CAST(FIT_TRAINING_SETTINGS_FIELD_NUM, 153))
...
typedef enum
{
   ...
   FIT_TRAINING_SETTINGS_MESG_PRECISE_TARGET_SPEED,
...
#define FIT_DIVE_SETTINGS_MESG_SIZE                                             60
#define FIT_DIVE_SETTINGS_MESG_DEF_SIZE                                         110
#define FIT_DIVE_SETTINGS_MESG_NAME_COUNT                                       1
...
typedef struct
{
   ...
   FIT_UINT32 ccr_low_setpoint_depth; // 1000 * m + 0, Depth to switch to low setpoint in automatic mode
   FIT_UINT32 ccr_high_setpoint_depth; // 1000 * m + 0, Depth to switch to high setpoint in automatic mode
   FIT_MESSAGE_INDEX message_index; //
   ...
   FIT_MESSAGE_INDEX travel_gas; // Index of travel dive_gas message
   ...
   FIT_CCR_SETPOINT_SWITCH_MODE ccr_low_setpoint_switch_mode; // If low PO2 should be switched to automatically
   FIT_UINT8 ccr_low_setpoint; // 100 * percent + 0, Target PO2 when using low setpoint
   FIT_CCR_SETPOINT_SWITCH_MODE ccr_high_setpoint_switch_mode; // If high PO2 should be switched to automatically
   FIT_UINT8 ccr_high_setpoint; // 100 * percent + 0, Target PO2 when using high setpoint
   FIT_GAS_CONSUMPTION_RATE_TYPE gas_consumption_display; // Type of gas consumption rate to display. Some values are only valid if tank volume is known.
   FIT_BOOL up_key_enabled; // Indicates whether the up key is enabled during dives
   FIT_TONE dive_sounds; // Sounds and vibration enabled or disabled in-dive
   FIT_UINT8 last_stop_multiple; // Usually 1.0/1.5/2.0 representing 3/4.5/6m or 10/15/20ft
   FIT_NO_FLY_TIME_MODE no_fly_time_mode; // Indicates which guidelines to use for no-fly surface interval.
} FIT_DIVE_SETTINGS_MESG;

typedef FIT_UINT8 FIT_DIVE_SETTINGS_FIELD_NUM;

#define FIT_DIVE_SETTINGS_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 253))
#define FIT_DIVE_SETTINGS_FIELD_NUM_WATER_DENSITY (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 5))
#define FIT_DIVE_SETTINGS_FIELD_NUM_BOTTOM_DEPTH (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 10))
#define FIT_DIVE_SETTINGS_FIELD_NUM_BOTTOM_TIME (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 11))
#define FIT_DIVE_SETTINGS_FIELD_NUM_APNEA_COUNTDOWN_TIME (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 13))
#define FIT_DIVE_SETTINGS_FIELD_NUM_CCR_LOW_SETPOINT_DEPTH (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 24))
#define FIT_DIVE_SETTINGS_FIELD_NUM_CCR_HIGH_SETPOINT_DEPTH (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 27))
#define FIT_DIVE_SETTINGS_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 254))
#define FIT_DIVE_SETTINGS_FIELD_NUM_REPEAT_DIVE_INTERVAL (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 17))
#define FIT_DIVE_SETTINGS_FIELD_NUM_SAFETY_STOP_TIME (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 18))
#define FIT_DIVE_SETTINGS_FIELD_NUM_TRAVEL_GAS (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 21))
#define FIT_DIVE_SETTINGS_FIELD_NUM_NAME (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 0))
#define FIT_DIVE_SETTINGS_FIELD_NUM_MODEL (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 1))
#define FIT_DIVE_SETTINGS_FIELD_NUM_GF_LOW (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 2))
#define FIT_DIVE_SETTINGS_FIELD_NUM_GF_HIGH (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 3))
#define FIT_DIVE_SETTINGS_FIELD_NUM_WATER_TYPE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 4))
#define FIT_DIVE_SETTINGS_FIELD_NUM_PO2_WARN (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 6))
#define FIT_DIVE_SETTINGS_FIELD_NUM_PO2_CRITICAL (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 7))
#define FIT_DIVE_SETTINGS_FIELD_NUM_PO2_DECO (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 8))
#define FIT_DIVE_SETTINGS_FIELD_NUM_SAFETY_STOP_ENABLED (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 9))
#define FIT_DIVE_SETTINGS_FIELD_NUM_APNEA_COUNTDOWN_ENABLED (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 12))
#define FIT_DIVE_SETTINGS_FIELD_NUM_BACKLIGHT_MODE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 14))
#define FIT_DIVE_SETTINGS_FIELD_NUM_BACKLIGHT_BRIGHTNESS (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 15))
#define FIT_DIVE_SETTINGS_FIELD_NUM_BACKLIGHT_TIMEOUT (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 16))
#define FIT_DIVE_SETTINGS_FIELD_NUM_HEART_RATE_SOURCE_TYPE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 19))
#define FIT_DIVE_SETTINGS_FIELD_NUM_HEART_RATE_SOURCE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 20))
#define FIT_DIVE_SETTINGS_FIELD_NUM_CCR_LOW_SETPOINT_SWITCH_MODE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 22))
#define FIT_DIVE_SETTINGS_FIELD_NUM_CCR_LOW_SETPOINT (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 23))
#define FIT_DIVE_SETTINGS_FIELD_NUM_CCR_HIGH_SETPOINT_SWITCH_MODE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 25))
#define FIT_DIVE_SETTINGS_FIELD_NUM_CCR_HIGH_SETPOINT (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 26))
#define FIT_DIVE_SETTINGS_FIELD_NUM_GAS_CONSUMPTION_DISPLAY (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 29))
#define FIT_DIVE_SETTINGS_FIELD_NUM_UP_KEY_ENABLED (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 30))
#define FIT_DIVE_SETTINGS_FIELD_NUM_DIVE_SOUNDS (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 35))
#define FIT_DIVE_SETTINGS_FIELD_NUM_LAST_STOP_MULTIPLE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 36))
#define FIT_DIVE_SETTINGS_FIELD_NUM_NO_FLY_TIME_MODE (FIT_CAST(FIT_DIVE_SETTINGS_FIELD_NUM, 37))

typedef enum
{
   FIT_DIVE_SETTINGS_MESG_TIMESTAMP,
   ...
   FIT_DIVE_SETTINGS_MESG_CCR_LOW_SETPOINT_DEPTH,
   FIT_DIVE_SETTINGS_MESG_CCR_HIGH_SETPOINT_DEPTH,
   FIT_DIVE_SETTINGS_MESG_MESSAGE_INDEX,
   FIT_DIVE_SETTINGS_MESG_REPEAT_DIVE_INTERVAL,
   FIT_DIVE_SETTINGS_MESG_SAFETY_STOP_TIME,
   FIT_DIVE_SETTINGS_MESG_TRAVEL_GAS,
   ...
   FIT_DIVE_SETTINGS_MESG_CCR_LOW_SETPOINT_SWITCH_MODE,
   FIT_DIVE_SETTINGS_MESG_CCR_LOW_SETPOINT,
   FIT_DIVE_SETTINGS_MESG_CCR_HIGH_SETPOINT_SWITCH_MODE,
   FIT_DIVE_SETTINGS_MESG_CCR_HIGH_SETPOINT,
   FIT_DIVE_SETTINGS_MESG_GAS_CONSUMPTION_DISPLAY,
   FIT_DIVE_SETTINGS_MESG_UP_KEY_ENABLED,
   FIT_DIVE_SETTINGS_MESG_DIVE_SOUNDS,
   FIT_DIVE_SETTINGS_MESG_LAST_STOP_MULTIPLE,
   FIT_DIVE_SETTINGS_MESG_NO_FLY_TIME_MODE,
...
// dive_alarm message
#define FIT_DIVE_ALARM_MESG_SIZE                                                26
#define FIT_DIVE_ALARM_MESG_DEF_SIZE                                            44
...
typedef struct
{
   ...
   FIT_UINT32 id; // Alarm ID
   FIT_SINT32 speed; // 1000 * mps + 0, Ascent/descent rate (mps) setting for speed type alarms
   ...
   FIT_BOOL popup_enabled; // Show a visible pop-up for this alarm
   FIT_BOOL trigger_on_descent; // Trigger the alarm on descent
   FIT_BOOL trigger_on_ascent; // Trigger the alarm on ascent
   FIT_BOOL repeating; // Repeat alarm each time threshold is crossed?
} FIT_DIVE_ALARM_MESG;

typedef FIT_UINT8 FIT_DIVE_ALARM_FIELD_NUM;

#define FIT_DIVE_ALARM_FIELD_NUM_DEPTH (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 0))
#define FIT_DIVE_ALARM_FIELD_NUM_TIME (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 1))
#define FIT_DIVE_ALARM_FIELD_NUM_ID (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 6))
#define FIT_DIVE_ALARM_FIELD_NUM_SPEED (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 11))
#define FIT_DIVE_ALARM_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 254))
#define FIT_DIVE_ALARM_FIELD_NUM_ENABLED (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 2))
#define FIT_DIVE_ALARM_FIELD_NUM_ALARM_TYPE (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 3))
#define FIT_DIVE_ALARM_FIELD_NUM_SOUND (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 4))
#define FIT_DIVE_ALARM_FIELD_NUM_DIVE_TYPES (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 5))
#define FIT_DIVE_ALARM_FIELD_NUM_POPUP_ENABLED (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 7))
#define FIT_DIVE_ALARM_FIELD_NUM_TRIGGER_ON_DESCENT (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 8))
#define FIT_DIVE_ALARM_FIELD_NUM_TRIGGER_ON_ASCENT (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 9))
#define FIT_DIVE_ALARM_FIELD_NUM_REPEATING (FIT_CAST(FIT_DIVE_ALARM_FIELD_NUM, 10))

typedef enum
{
   FIT_DIVE_ALARM_MESG_DEPTH,
   FIT_DIVE_ALARM_MESG_TIME,
   FIT_DIVE_ALARM_MESG_ID,
   FIT_DIVE_ALARM_MESG_SPEED,
   ...
   FIT_DIVE_ALARM_MESG_POPUP_ENABLED,
   FIT_DIVE_ALARM_MESG_TRIGGER_ON_DESCENT,
   FIT_DIVE_ALARM_MESG_TRIGGER_ON_ASCENT,
   FIT_DIVE_ALARM_MESG_REPEATING,
...
// dive_apnea_alarm message
#define FIT_DIVE_APNEA_ALARM_MESG_SIZE                                          26
#define FIT_DIVE_APNEA_ALARM_MESG_DEF_SIZE                                      44
#define FIT_DIVE_APNEA_ALARM_MESG_DIVE_TYPES_COUNT                              1
...
typedef struct
{
   ...
   FIT_DIVE_ALARM_TYPE alarm_type; // Alarm type setting
   FIT_TONE sound; // Tone and Vibe setting for the alarm.
   FIT_SUB_SPORT dive_types[FIT_DIVE_APNEA_ALARM_MESG_DIVE_TYPES_COUNT]; // Dive types the alarm will trigger on
   FIT_BOOL popup_enabled; // Show a visible pop-up for this alarm
   FIT_BOOL trigger_on_descent; // Trigger the alarm on descent
   FIT_BOOL trigger_on_ascent; // Trigger the alarm on ascent
   FIT_BOOL repeating; // Repeat alarm each time threshold is crossed?
} FIT_DIVE_APNEA_ALARM_MESG;

typedef FIT_UINT8 FIT_DIVE_APNEA_ALARM_FIELD_NUM;

#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_DEPTH (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 0))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_TIME (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 1))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_ID (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 6))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_SPEED (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 11))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 254))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_ENABLED (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 2))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_ALARM_TYPE (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 3))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_SOUND (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 4))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_DIVE_TYPES (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 5))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_POPUP_ENABLED (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 7))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_TRIGGER_ON_DESCENT (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 8))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_TRIGGER_ON_ASCENT (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 9))
#define FIT_DIVE_APNEA_ALARM_FIELD_NUM_REPEATING (FIT_CAST(FIT_DIVE_APNEA_ALARM_FIELD_NUM, 10))

typedef enum
{
   FIT_DIVE_APNEA_ALARM_MESG_DEPTH,
   FIT_DIVE_APNEA_ALARM_MESG_TIME,
   FIT_DIVE_APNEA_ALARM_MESG_ID,
   FIT_DIVE_APNEA_ALARM_MESG_SPEED,
   FIT_DIVE_APNEA_ALARM_MESG_MESSAGE_INDEX,
   FIT_DIVE_APNEA_ALARM_MESG_ENABLED,
   FIT_DIVE_APNEA_ALARM_MESG_ALARM_TYPE,
   FIT_DIVE_APNEA_ALARM_MESG_SOUND,
   FIT_DIVE_APNEA_ALARM_MESG_DIVE_TYPES,
   FIT_DIVE_APNEA_ALARM_MESG_POPUP_ENABLED,
   FIT_DIVE_APNEA_ALARM_MESG_TRIGGER_ON_DESCENT,
   FIT_DIVE_APNEA_ALARM_MESG_TRIGGER_ON_ASCENT,
   FIT_DIVE_APNEA_ALARM_MESG_REPEATING,
   FIT_DIVE_APNEA_ALARM_MESG_FIELDS
} FIT_DIVE_APNEA_ALARM_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_DIVE_APNEA_ALARM_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_DIVE_APNEA_ALARM_MESG_DEF;

// dive_gas message
#define FIT_DIVE_GAS_MESG_SIZE                                                  6
#define FIT_DIVE_GAS_MESG_DEF_SIZE                                              20
...
typedef struct
{
   ...
   FIT_DIVE_GAS_MODE mode; //
} FIT_DIVE_GAS_MESG;

typedef FIT_UINT8 FIT_DIVE_GAS_FIELD_NUM;

#define FIT_DIVE_GAS_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_DIVE_GAS_FIELD_NUM, 254))
#define FIT_DIVE_GAS_FIELD_NUM_HELIUM_CONTENT (FIT_CAST(FIT_DIVE_GAS_FIELD_NUM, 0))
#define FIT_DIVE_GAS_FIELD_NUM_OXYGEN_CONTENT (FIT_CAST(FIT_DIVE_GAS_FIELD_NUM, 1))
#define FIT_DIVE_GAS_FIELD_NUM_STATUS (FIT_CAST(FIT_DIVE_GAS_FIELD_NUM, 2))
#define FIT_DIVE_GAS_FIELD_NUM_MODE (FIT_CAST(FIT_DIVE_GAS_FIELD_NUM, 3))
...
// session message
#define FIT_SESSION_MESG_SIZE                                                   340
#define FIT_SESSION_MESG_DEF_SIZE                                               479
...
#define FIT_SESSION_MESG_SPORT_PROFILE_NAME_COUNT                               1
#define FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_COUNT                             1
#define FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_PEAK_COUNT                        1
#define FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_COUNT                            1
#define FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_PEAK_COUNT                       1
...
typedef struct
{
   ...
   FIT_UINT16 avg_total_hemoglobin_conc[FIT_SESSION_MESG_AVG_TOTAL_HEMOGLOBIN_CONC_COUNT]; // 100 * g/dL + 0, Avg saturated and unsaturated hemoglobin
   FIT_UINT16 min_total_hemoglobin_conc[FIT_SESSION_MESG_MIN_TOTAL_HEMOGLOBIN_CONC_COUNT]; // 100 * g/dL + 0, Min saturated and unsaturated hemoglobin
   FIT_UINT16 max_total_hemoglobin_conc[FIT_SESSION_MESG_MAX_TOTAL_HEMOGLOBIN_CONC_COUNT]; // 100 * g/dL + 0, Max saturated and unsaturated hemoglobin
   FIT_UINT16 avg_saturated_hemoglobin_percent[FIT_SESSION_MESG_AVG_SATURATED_HEMOGLOBIN_PERCENT_COUNT]; // 10 * % + 0, Avg percentage of hemoglobin saturated with oxygen
   ...
   FIT_UINT16 enhanced_avg_respiration_rate; // 100 * Breaths/min + 0,
   FIT_UINT16 enhanced_max_respiration_rate; // 100 * Breaths/min + 0,
   FIT_UINT16 enhanced_min_respiration_rate; //
   FIT_UINT16 jump_count; //
   FIT_UINT16 metabolic_calories; // 1 * kcal + 0,
   ...
   FIT_SINT8 avg_left_pco; // 1 * mm + 0, Average platform center offset Left
   FIT_SINT8 avg_right_pco; // 1 * mm + 0, Average platform center offset Right
   FIT_UINT8 avg_left_power_phase[FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_COUNT]; // 0.7111111 * degrees + 0, Average left power phase angles. Indexes defined by power_phase_type.
   FIT_UINT8 avg_left_power_phase_peak[FIT_SESSION_MESG_AVG_LEFT_POWER_PHASE_PEAK_COUNT]; // 0.7111111 * degrees + 0, Average left power phase peak angles. Data value indexes defined by power_phase_type.
   FIT_UINT8 avg_right_power_phase[FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_COUNT]; // 0.7111111 * degrees + 0, Average right power phase angles. Data value indexes defined by power_phase_type.
   FIT_UINT8 avg_right_power_phase_peak[FIT_SESSION_MESG_AVG_RIGHT_POWER_PHASE_PEAK_COUNT]; // 0.7111111 * degrees + 0, Average right power phase peak angles data value indexes defined by power_phase_type.
   FIT_UINT8 avg_cadence_position[FIT_SESSION_MESG_AVG_CADENCE_POSITION_COUNT]; // 1 * rpm + 0, Average cadence by position. Data value indexes defined by rider_position_type.
   FIT_UINT8 max_cadence_position[FIT_SESSION_MESG_MAX_CADENCE_POSITION_COUNT]; // 1 * rpm + 0, Maximum cadence by position. Data value indexes defined by rider_position_type.
   FIT_UINT8 lev_battery_consumption; // 2 * percent + 0, lev battery consumption during session
   FIT_UINT8 total_anaerobic_training_effect; //
   FIT_UINT8 start_cns; // 1 * percent + 0,
   FIT_UINT8 end_cns; // 1 * percent + 0,
   FIT_UINT8 avg_respiration_rate; //
   FIT_UINT8 max_respiration_rate; //
   FIT_UINT8 min_respiration_rate; //
   FIT_SINT8 min_temperature; // 1 * C + 0,
   FIT_UINT8 workout_feel; // A 0-100 scale representing how a user felt while performing a workout. Low values are considered feeling bad, while high values are good.
   FIT_UINT8 workout_rpe; // Common Borg CR10 / 0-10 RPE scale, multiplied 10x.. Aggregate score for all workouts in a single session.
   FIT_UINT8 avg_spo2; // 1 * percent + 0, Average SPO2 for the monitoring session
   FIT_UINT8 avg_stress; // 1 * percent + 0, Average stress for the monitoring session
   FIT_UINT8 sdrr_hrv; // 1 * mS + 0, Standard deviation of R-R interval (SDRR) - Heart rate variability measure most useful for wellness users.
   FIT_UINT8 rmssd_hrv; // 1 * mS + 0, Root mean square successive difference (RMSSD) - Heart rate variability measure most useful for athletes
...
#define FIT_SESSION_FIELD_NUM_ACTIVE_TIME (FIT_CAST(FIT_SESSION_FIELD_NUM, 78))
#define FIT_SESSION_FIELD_NUM_TIME_STANDING (FIT_CAST(FIT_SESSION_FIELD_NUM, 112))
...
#define FIT_SESSION_FIELD_NUM_AVG_DEPTH (FIT_CAST(FIT_SESSION_FIELD_NUM, 140))
#define FIT_SESSION_FIELD_NUM_MAX_DEPTH (FIT_CAST(FIT_SESSION_FIELD_NUM, 141))
#define FIT_SESSION_FIELD_NUM_SURFACE_INTERVAL (FIT_CAST(FIT_SESSION_FIELD_NUM, 142))
#define FIT_SESSION_FIELD_NUM_DIVE_NUMBER (FIT_CAST(FIT_SESSION_FIELD_NUM, 156))
#define FIT_SESSION_FIELD_NUM_TRAINING_LOAD_PEAK (FIT_CAST(FIT_SESSION_FIELD_NUM, 168))
#define FIT_SESSION_FIELD_NUM_TOTAL_GRIT (FIT_CAST(FIT_SESSION_FIELD_NUM, 181))
#define FIT_SESSION_FIELD_NUM_TOTAL_FLOW (FIT_CAST(FIT_SESSION_FIELD_NUM, 182))
#define FIT_SESSION_FIELD_NUM_AVG_GRIT (FIT_CAST(FIT_SESSION_FIELD_NUM, 186))
#define FIT_SESSION_FIELD_NUM_AVG_FLOW (FIT_CAST(FIT_SESSION_FIELD_NUM, 187))
...
#define FIT_SESSION_FIELD_NUM_AVG_TOTAL_HEMOGLOBIN_CONC (FIT_CAST(FIT_SESSION_FIELD_NUM, 95))
#define FIT_SESSION_FIELD_NUM_MIN_TOTAL_HEMOGLOBIN_CONC (FIT_CAST(FIT_SESSION_FIELD_NUM, 96))
#define FIT_SESSION_FIELD_NUM_MAX_TOTAL_HEMOGLOBIN_CONC (FIT_CAST(FIT_SESSION_FIELD_NUM, 97))
#define FIT_SESSION_FIELD_NUM_AVG_SATURATED_HEMOGLOBIN_PERCENT (FIT_CAST(FIT_SESSION_FIELD_NUM, 98))
#define FIT_SESSION_FIELD_NUM_MIN_SATURATED_HEMOGLOBIN_PERCENT (FIT_CAST(FIT_SESSION_FIELD_NUM, 99))
#define FIT_SESSION_FIELD_NUM_MAX_SATURATED_HEMOGLOBIN_PERCENT (FIT_CAST(FIT_SESSION_FIELD_NUM, 100))
#define FIT_SESSION_FIELD_NUM_STAND_COUNT (FIT_CAST(FIT_SESSION_FIELD_NUM, 113))
#define FIT_SESSION_FIELD_NUM_AVG_POWER_POSITION (FIT_CAST(FIT_SESSION_FIELD_NUM, 120))
#define FIT_SESSION_FIELD_NUM_MAX_POWER_POSITION (FIT_CAST(FIT_SESSION_FIELD_NUM, 121))
#define FIT_SESSION_FIELD_NUM_AVG_LEV_MOTOR_POWER (FIT_CAST(FIT_SESSION_FIELD_NUM, 129))
#define FIT_SESSION_FIELD_NUM_MAX_LEV_MOTOR_POWER (FIT_CAST(FIT_SESSION_FIELD_NUM, 130))
#define FIT_SESSION_FIELD_NUM_AVG_VERTICAL_RATIO (FIT_CAST(FIT_SESSION_FIELD_NUM, 132))
#define FIT_SESSION_FIELD_NUM_AVG_STANCE_TIME_BALANCE (FIT_CAST(FIT_SESSION_FIELD_NUM, 133))
#define FIT_SESSION_FIELD_NUM_AVG_STEP_LENGTH (FIT_CAST(FIT_SESSION_FIELD_NUM, 134))
#define FIT_SESSION_FIELD_NUM_AVG_VAM (FIT_CAST(FIT_SESSION_FIELD_NUM, 139))
#define FIT_SESSION_FIELD_NUM_START_N2 (FIT_CAST(FIT_SESSION_FIELD_NUM, 145))
#define FIT_SESSION_FIELD_NUM_END_N2 (FIT_CAST(FIT_SESSION_FIELD_NUM, 146))
#define FIT_SESSION_FIELD_NUM_O2_TOXICITY (FIT_CAST(FIT_SESSION_FIELD_NUM, 155))
#define FIT_SESSION_FIELD_NUM_ENHANCED_AVG_RESPIRATION_RATE (FIT_CAST(FIT_SESSION_FIELD_NUM, 169))
#define FIT_SESSION_FIELD_NUM_ENHANCED_MAX_RESPIRATION_RATE (FIT_CAST(FIT_SESSION_FIELD_NUM, 170))
#define FIT_SESSION_FIELD_NUM_ENHANCED_MIN_RESPIRATION_RATE (FIT_CAST(FIT_SESSION_FIELD_NUM, 180))
#define FIT_SESSION_FIELD_NUM_JUMP_COUNT (FIT_CAST(FIT_SESSION_FIELD_NUM, 183))
#define FIT_SESSION_FIELD_NUM_METABOLIC_CALORIES (FIT_CAST(FIT_SESSION_FIELD_NUM, 196))
#define FIT_SESSION_FIELD_NUM_AVG_CORE_TEMPERATURE (FIT_CAST(FIT_SESSION_FIELD_NUM, 208))
#define FIT_SESSION_FIELD_NUM_MIN_CORE_TEMPERATURE (FIT_CAST(FIT_SESSION_FIELD_NUM, 209))
#define FIT_SESSION_FIELD_NUM_MAX_CORE_TEMPERATURE (FIT_CAST(FIT_SESSION_FIELD_NUM, 210))
...
#define FIT_SESSION_FIELD_NUM_AVG_LEFT_TORQUE_EFFECTIVENESS (FIT_CAST(FIT_SESSION_FIELD_NUM, 101))
#define FIT_SESSION_FIELD_NUM_AVG_RIGHT_TORQUE_EFFECTIVENESS (FIT_CAST(FIT_SESSION_FIELD_NUM, 102))
#define FIT_SESSION_FIELD_NUM_AVG_LEFT_PEDAL_SMOOTHNESS (FIT_CAST(FIT_SESSION_FIELD_NUM, 103))
#define FIT_SESSION_FIELD_NUM_AVG_RIGHT_PEDAL_SMOOTHNESS (FIT_CAST(FIT_SESSION_FIELD_NUM, 104))
#define FIT_SESSION_FIELD_NUM_AVG_COMBINED_PEDAL_SMOOTHNESS (FIT_CAST(FIT_SESSION_FIELD_NUM, 105))
...
#define FIT_SESSION_FIELD_NUM_AVG_LEFT_PCO (FIT_CAST(FIT_SESSION_FIELD_NUM, 114))
#define FIT_SESSION_FIELD_NUM_AVG_RIGHT_PCO (FIT_CAST(FIT_SESSION_FIELD_NUM, 115))
#define FIT_SESSION_FIELD_NUM_AVG_LEFT_POWER_PHASE (FIT_CAST(FIT_SESSION_FIELD_NUM, 116))
#define FIT_SESSION_FIELD_NUM_AVG_LEFT_POWER_PHASE_PEAK (FIT_CAST(FIT_SESSION_FIELD_NUM, 117))
#define FIT_SESSION_FIELD_NUM_AVG_RIGHT_POWER_PHASE (FIT_CAST(FIT_SESSION_FIELD_NUM, 118))
#define FIT_SESSION_FIELD_NUM_AVG_RIGHT_POWER_PHASE_PEAK (FIT_CAST(FIT_SESSION_FIELD_NUM, 119))
#define FIT_SESSION_FIELD_NUM_AVG_CADENCE_POSITION (FIT_CAST(FIT_SESSION_FIELD_NUM, 122))
#define FIT_SESSION_FIELD_NUM_MAX_CADENCE_POSITION (FIT_CAST(FIT_SESSION_FIELD_NUM, 123))
#define FIT_SESSION_FIELD_NUM_LEV_BATTERY_CONSUMPTION (FIT_CAST(FIT_SESSION_FIELD_NUM, 131))
#define FIT_SESSION_FIELD_NUM_TOTAL_ANAEROBIC_TRAINING_EFFECT (FIT_CAST(FIT_SESSION_FIELD_NUM, 137))
#define FIT_SESSION_FIELD_NUM_START_CNS (FIT_CAST(FIT_SESSION_FIELD_NUM, 143))
#define FIT_SESSION_FIELD_NUM_END_CNS (FIT_CAST(FIT_SESSION_FIELD_NUM, 144))
#define FIT_SESSION_FIELD_NUM_AVG_RESPIRATION_RATE (FIT_CAST(FIT_SESSION_FIELD_NUM, 147))
#define FIT_SESSION_FIELD_NUM_MAX_RESPIRATION_RATE (FIT_CAST(FIT_SESSION_FIELD_NUM, 148))
#define FIT_SESSION_FIELD_NUM_MIN_RESPIRATION_RATE (FIT_CAST(FIT_SESSION_FIELD_NUM, 149))
#define FIT_SESSION_FIELD_NUM_MIN_TEMPERATURE (FIT_CAST(FIT_SESSION_FIELD_NUM, 150))
#define FIT_SESSION_FIELD_NUM_WORKOUT_FEEL (FIT_CAST(FIT_SESSION_FIELD_NUM, 192))
#define FIT_SESSION_FIELD_NUM_WORKOUT_RPE (FIT_CAST(FIT_SESSION_FIELD_NUM, 193))
#define FIT_SESSION_FIELD_NUM_AVG_SPO2 (FIT_CAST(FIT_SESSION_FIELD_NUM, 194))
#define FIT_SESSION_FIELD_NUM_AVG_STRESS (FIT_CAST(FIT_SESSION_FIELD_NUM, 195))
#define FIT_SESSION_FIELD_NUM_SDRR_HRV (FIT_CAST(FIT_SESSION_FIELD_NUM, 197))
#define FIT_SESSION_FIELD_NUM_RMSSD_HRV (FIT_CAST(FIT_SESSION_FIELD_NUM, 198))
#define FIT_SESSION_FIELD_NUM_TOTAL_FRACTIONAL_ASCENT (FIT_CAST(FIT_SESSION_FIELD_NUM, 199))
#define FIT_SESSION_FIELD_NUM_TOTAL_FRACTIONAL_DESCENT (FIT_CAST(FIT_SESSION_FIELD_NUM, 200))
...
typedef enum
{
   ...
   FIT_SESSION_MESG_AVG_DEPTH,
   FIT_SESSION_MESG_MAX_DEPTH,
   FIT_SESSION_MESG_SURFACE_INTERVAL,
   FIT_SESSION_MESG_DIVE_NUMBER,
   FIT_SESSION_MESG_TRAINING_LOAD_PEAK,
   FIT_SESSION_MESG_TOTAL_GRIT,
   FIT_SESSION_MESG_TOTAL_FLOW,
   FIT_SESSION_MESG_AVG_GRIT,
   FIT_SESSION_MESG_AVG_FLOW,
   ...
   FIT_SESSION_MESG_AVG_TOTAL_HEMOGLOBIN_CONC,
   FIT_SESSION_MESG_MIN_TOTAL_HEMOGLOBIN_CONC,
   FIT_SESSION_MESG_MAX_TOTAL_HEMOGLOBIN_CONC,
   FIT_SESSION_MESG_AVG_SATURATED_HEMOGLOBIN_PERCENT,
   ...
   FIT_SESSION_MESG_AVG_STANCE_TIME_BALANCE,
   FIT_SESSION_MESG_AVG_STEP_LENGTH,
   FIT_SESSION_MESG_AVG_VAM,
   FIT_SESSION_MESG_START_N2,
   FIT_SESSION_MESG_END_N2,
   FIT_SESSION_MESG_O2_TOXICITY,
   FIT_SESSION_MESG_ENHANCED_AVG_RESPIRATION_RATE,
   FIT_SESSION_MESG_ENHANCED_MAX_RESPIRATION_RATE,
   FIT_SESSION_MESG_ENHANCED_MIN_RESPIRATION_RATE,
   FIT_SESSION_MESG_JUMP_COUNT,
   FIT_SESSION_MESG_METABOLIC_CALORIES,
   FIT_SESSION_MESG_AVG_CORE_TEMPERATURE,
   FIT_SESSION_MESG_MIN_CORE_TEMPERATURE,
   FIT_SESSION_MESG_MAX_CORE_TEMPERATURE,
   ...
   FIT_SESSION_MESG_AVG_LEFT_TORQUE_EFFECTIVENESS,
   FIT_SESSION_MESG_AVG_RIGHT_TORQUE_EFFECTIVENESS,
   FIT_SESSION_MESG_AVG_LEFT_PEDAL_SMOOTHNESS,
   FIT_SESSION_MESG_AVG_RIGHT_PEDAL_SMOOTHNESS,
   FIT_SESSION_MESG_AVG_COMBINED_PEDAL_SMOOTHNESS,
   ...
   FIT_SESSION_MESG_AVG_CADENCE_POSITION,
   FIT_SESSION_MESG_MAX_CADENCE_POSITION,
   FIT_SESSION_MESG_LEV_BATTERY_CONSUMPTION,
   FIT_SESSION_MESG_TOTAL_ANAEROBIC_TRAINING_EFFECT,
   FIT_SESSION_MESG_START_CNS,
   FIT_SESSION_MESG_END_CNS,
   FIT_SESSION_MESG_AVG_RESPIRATION_RATE,
   FIT_SESSION_MESG_MAX_RESPIRATION_RATE,
   FIT_SESSION_MESG_MIN_RESPIRATION_RATE,
   FIT_SESSION_MESG_MIN_TEMPERATURE,
   FIT_SESSION_MESG_WORKOUT_FEEL,
   FIT_SESSION_MESG_WORKOUT_RPE,
   FIT_SESSION_MESG_AVG_SPO2,
   FIT_SESSION_MESG_AVG_STRESS,
   FIT_SESSION_MESG_SDRR_HRV,
   FIT_SESSION_MESG_RMSSD_HRV,
   FIT_SESSION_MESG_TOTAL_FRACTIONAL_ASCENT,
   FIT_SESSION_MESG_TOTAL_FRACTIONAL_DESCENT,
...
// lap message
#define FIT_LAP_MESG_SIZE                                                       268
#define FIT_LAP_MESG_DEF_SIZE                                                   377
...
#define FIT_LAP_FIELD_NUM_ACTIVE_TIME (FIT_CAST(FIT_LAP_FIELD_NUM, 70))
#define FIT_LAP_FIELD_NUM_TIME_STANDING (FIT_CAST(FIT_LAP_FIELD_NUM, 98))
...
#define FIT_LAP_FIELD_NUM_AVG_DEPTH (FIT_CAST(FIT_LAP_FIELD_NUM, 122))
#define FIT_LAP_FIELD_NUM_MAX_DEPTH (FIT_CAST(FIT_LAP_FIELD_NUM, 123))
#define FIT_LAP_FIELD_NUM_TOTAL_GRIT (FIT_CAST(FIT_LAP_FIELD_NUM, 149))
#define FIT_LAP_FIELD_NUM_TOTAL_FLOW (FIT_CAST(FIT_LAP_FIELD_NUM, 150))
#define FIT_LAP_FIELD_NUM_AVG_GRIT (FIT_CAST(FIT_LAP_FIELD_NUM, 153))
#define FIT_LAP_FIELD_NUM_AVG_FLOW (FIT_CAST(FIT_LAP_FIELD_NUM, 154))
...
#define FIT_LAP_FIELD_NUM_STAND_COUNT (FIT_CAST(FIT_LAP_FIELD_NUM, 99))
#define FIT_LAP_FIELD_NUM_AVG_POWER_POSITION (FIT_CAST(FIT_LAP_FIELD_NUM, 106))
#define FIT_LAP_FIELD_NUM_MAX_POWER_POSITION (FIT_CAST(FIT_LAP_FIELD_NUM, 107))
#define FIT_LAP_FIELD_NUM_AVG_LEV_MOTOR_POWER (FIT_CAST(FIT_LAP_FIELD_NUM, 115))
#define FIT_LAP_FIELD_NUM_MAX_LEV_MOTOR_POWER (FIT_CAST(FIT_LAP_FIELD_NUM, 116))
#define FIT_LAP_FIELD_NUM_AVG_VERTICAL_RATIO (FIT_CAST(FIT_LAP_FIELD_NUM, 118))
#define FIT_LAP_FIELD_NUM_AVG_STANCE_TIME_BALANCE (FIT_CAST(FIT_LAP_FIELD_NUM, 119))
#define FIT_LAP_FIELD_NUM_AVG_STEP_LENGTH (FIT_CAST(FIT_LAP_FIELD_NUM, 120))
#define FIT_LAP_FIELD_NUM_AVG_VAM (FIT_CAST(FIT_LAP_FIELD_NUM, 121))
#define FIT_LAP_FIELD_NUM_ENHANCED_AVG_RESPIRATION_RATE (FIT_CAST(FIT_LAP_FIELD_NUM, 136))
#define FIT_LAP_FIELD_NUM_ENHANCED_MAX_RESPIRATION_RATE (FIT_CAST(FIT_LAP_FIELD_NUM, 137))
#define FIT_LAP_FIELD_NUM_JUMP_COUNT (FIT_CAST(FIT_LAP_FIELD_NUM, 151))
#define FIT_LAP_FIELD_NUM_AVG_CORE_TEMPERATURE (FIT_CAST(FIT_LAP_FIELD_NUM, 158))
#define FIT_LAP_FIELD_NUM_MIN_CORE_TEMPERATURE (FIT_CAST(FIT_LAP_FIELD_NUM, 159))
#define FIT_LAP_FIELD_NUM_MAX_CORE_TEMPERATURE (FIT_CAST(FIT_LAP_FIELD_NUM, 160))
...
#define FIT_LAP_FIELD_NUM_AVG_LEFT_TORQUE_EFFECTIVENESS (FIT_CAST(FIT_LAP_FIELD_NUM, 91))
#define FIT_LAP_FIELD_NUM_AVG_RIGHT_TORQUE_EFFECTIVENESS (FIT_CAST(FIT_LAP_FIELD_NUM, 92))
#define FIT_LAP_FIELD_NUM_AVG_LEFT_PEDAL_SMOOTHNESS (FIT_CAST(FIT_LAP_FIELD_NUM, 93))
#define FIT_LAP_FIELD_NUM_AVG_RIGHT_PEDAL_SMOOTHNESS (FIT_CAST(FIT_LAP_FIELD_NUM, 94))
#define FIT_LAP_FIELD_NUM_AVG_COMBINED_PEDAL_SMOOTHNESS (FIT_CAST(FIT_LAP_FIELD_NUM, 95))
#define FIT_LAP_FIELD_NUM_AVG_LEFT_PCO (FIT_CAST(FIT_LAP_FIELD_NUM, 100))
#define FIT_LAP_FIELD_NUM_AVG_RIGHT_PCO (FIT_CAST(FIT_LAP_FIELD_NUM, 101))
#define FIT_LAP_FIELD_NUM_AVG_LEFT_POWER_PHASE (FIT_CAST(FIT_LAP_FIELD_NUM, 102))
#define FIT_LAP_FIELD_NUM_AVG_LEFT_POWER_PHASE_PEAK (FIT_CAST(FIT_LAP_FIELD_NUM, 103))
#define FIT_LAP_FIELD_NUM_AVG_RIGHT_POWER_PHASE (FIT_CAST(FIT_LAP_FIELD_NUM, 104))
#define FIT_LAP_FIELD_NUM_AVG_RIGHT_POWER_PHASE_PEAK (FIT_CAST(FIT_LAP_FIELD_NUM, 105))
#define FIT_LAP_FIELD_NUM_AVG_CADENCE_POSITION (FIT_CAST(FIT_LAP_FIELD_NUM, 108))
#define FIT_LAP_FIELD_NUM_MAX_CADENCE_POSITION (FIT_CAST(FIT_LAP_FIELD_NUM, 109))
#define FIT_LAP_FIELD_NUM_LEV_BATTERY_CONSUMPTION (FIT_CAST(FIT_LAP_FIELD_NUM, 117))
#define FIT_LAP_FIELD_NUM_MIN_TEMPERATURE (FIT_CAST(FIT_LAP_FIELD_NUM, 124))
#define FIT_LAP_FIELD_NUM_AVG_RESPIRATION_RATE (FIT_CAST(FIT_LAP_FIELD_NUM, 147))
#define FIT_LAP_FIELD_NUM_MAX_RESPIRATION_RATE (FIT_CAST(FIT_LAP_FIELD_NUM, 148))
#define FIT_LAP_FIELD_NUM_TOTAL_FRACTIONAL_ASCENT (FIT_CAST(FIT_LAP_FIELD_NUM, 156))
#define FIT_LAP_FIELD_NUM_TOTAL_FRACTIONAL_DESCENT (FIT_CAST(FIT_LAP_FIELD_NUM, 157))
...
typedef enum
{
   ...
   FIT_LAP_MESG_AVG_DEPTH,
   FIT_LAP_MESG_MAX_DEPTH,
   ...
   FIT_LAP_MESG_ENHANCED_AVG_RESPIRATION_RATE,
   FIT_LAP_MESG_ENHANCED_MAX_RESPIRATION_RATE,
   ...
   FIT_LAP_MESG_AVG_RESPIRATION_RATE,
   FIT_LAP_MESG_MAX_RESPIRATION_RATE,
...
// length message
#define FIT_LENGTH_MESG_SIZE                                                    44
#define FIT_LENGTH_MESG_DEF_SIZE                                                71
...
#define FIT_LENGTH_FIELD_NUM_ENHANCED_AVG_RESPIRATION_RATE (FIT_CAST(FIT_LENGTH_FIELD_NUM, 22))
#define FIT_LENGTH_FIELD_NUM_ENHANCED_MAX_RESPIRATION_RATE (FIT_CAST(FIT_LENGTH_FIELD_NUM, 23))
...
#define FIT_LENGTH_FIELD_NUM_AVG_RESPIRATION_RATE (FIT_CAST(FIT_LENGTH_FIELD_NUM, 24))
#define FIT_LENGTH_FIELD_NUM_MAX_RESPIRATION_RATE (FIT_CAST(FIT_LENGTH_FIELD_NUM, 25))
...
typedef enum
{
   ...
   FIT_LENGTH_MESG_ENHANCED_AVG_RESPIRATION_RATE,
   FIT_LENGTH_MESG_ENHANCED_MAX_RESPIRATION_RATE,
   ...
   FIT_LENGTH_MESG_AVG_RESPIRATION_RATE,
   FIT_LENGTH_MESG_MAX_RESPIRATION_RATE,
...
// record message
#define FIT_RECORD_MESG_SIZE                                                    174
#define FIT_RECORD_MESG_DEF_SIZE                                                257
#define FIT_RECORD_MESG_COMPRESSED_SPEED_DISTANCE_COUNT                         3
#define FIT_RECORD_MESG_SPEED_1S_COUNT                                          1
...
typedef struct
{
   ...
   FIT_UINT32 absolute_pressure; // 1 * Pa + 0, Includes atmospheric pressure
   FIT_UINT32 depth; // 1000 * m + 0, 0 if above water
   FIT_UINT32 next_stop_depth; // 1000 * m + 0, 0 if above water
   FIT_UINT32 next_stop_time; // 1 * s + 0,
   FIT_UINT32 time_to_surface; // 1 * s + 0,
   FIT_UINT32 ndl_time; // 1 * s + 0,
   FIT_FLOAT32 grit; // The grit score estimates how challenging a route could be for a cyclist in terms of time spent going over sharp turns or large grade slopes.
   FIT_FLOAT32 flow; // The flow score estimates how long distance wise a cyclist deaccelerates over intervals where deacceleration is unnecessary such as smooth turns or small grade angle intervals.
   FIT_UINT32 air_time_remaining; // 1 * s + 0,
   FIT_SINT32 ascent_rate; // 1000 * m/s + 0,
   ...
   FIT_UINT16 motor_power; // 1 * watts + 0, lev motor power
   FIT_UINT16 vertical_ratio; // 100 * percent + 0,
   FIT_UINT16 stance_time_balance; // 100 * percent + 0,
   FIT_UINT16 step_length; // 10 * mm + 0,
   FIT_UINT16 cycle_length16; // 100 * m + 0, Supports larger cycle sizes needed for paddlesports. Max cycle size: 655.35
   FIT_UINT16 n2_load; // 1 * percent + 0,
   FIT_UINT16 enhanced_respiration_rate; // 100 * Breaths/min + 0,
   FIT_UINT16 current_stress; // Current Stress value
   FIT_UINT16 ebike_travel_range; // 1 * km + 0,
   FIT_UINT16 pressure_sac; // 100 * bar/min + 0, Pressure-based surface air consumption
   FIT_UINT16 volume_sac; // 100 * L/min + 0, Volumetric surface air consumption
   FIT_UINT16 rmv; // 100 * L/min + 0, Respiratory minute volume
   FIT_UINT16 core_temperature; // 100 * C + 0,
   ...
   FIT_SINT8 left_pco; // 1 * mm + 0, Left platform center offset
   FIT_SINT8 right_pco; // 1 * mm + 0, Right platform center offset
   FIT_UINT8 left_power_phase[FIT_RECORD_MESG_LEFT_POWER_PHASE_COUNT]; // 0.7111111 * degrees + 0, Left power phase angles. Data value indexes defined by power_phase_type.
   FIT_UINT8 left_power_phase_peak[FIT_RECORD_MESG_LEFT_POWER_PHASE_PEAK_COUNT]; // 0.7111111 * degrees + 0, Left power phase peak angles. Data value indexes defined by power_phase_type.
   FIT_UINT8 right_power_phase[FIT_RECORD_MESG_RIGHT_POWER_PHASE_COUNT]; // 0.7111111 * degrees + 0, Right power phase angles. Data value indexes defined by power_phase_type.
   FIT_UINT8 right_power_phase_peak[FIT_RECORD_MESG_RIGHT_POWER_PHASE_PEAK_COUNT]; // 0.7111111 * degrees + 0, Right power phase peak angles. Data value indexes defined by power_phase_type.
   FIT_UINT8 battery_soc; // 2 * percent + 0, lev battery state of charge
   FIT_UINT8 cns_load; // 1 * percent + 0,
   FIT_UINT8 respiration_rate; // 1 * s + 0,
   FIT_UINT8 ebike_battery_level; // 1 * percent + 0,
   FIT_UINT8 ebike_assist_mode; // 1 * depends on sensor + 0,
   FIT_UINT8 ebike_assist_level_percent; // 1 * percent + 0,
   FIT_UINT8 po2; // 100 * percent + 0, Current partial pressure of oxygen
} FIT_RECORD_MESG;
...
#define FIT_RECORD_FIELD_NUM_ABSOLUTE_PRESSURE (FIT_CAST(FIT_RECORD_FIELD_NUM, 91))
#define FIT_RECORD_FIELD_NUM_DEPTH (FIT_CAST(FIT_RECORD_FIELD_NUM, 92))
#define FIT_RECORD_FIELD_NUM_NEXT_STOP_DEPTH (FIT_CAST(FIT_RECORD_FIELD_NUM, 93))
#define FIT_RECORD_FIELD_NUM_NEXT_STOP_TIME (FIT_CAST(FIT_RECORD_FIELD_NUM, 94))
#define FIT_RECORD_FIELD_NUM_TIME_TO_SURFACE (FIT_CAST(FIT_RECORD_FIELD_NUM, 95))
#define FIT_RECORD_FIELD_NUM_NDL_TIME (FIT_CAST(FIT_RECORD_FIELD_NUM, 96))
#define FIT_RECORD_FIELD_NUM_GRIT (FIT_CAST(FIT_RECORD_FIELD_NUM, 114))
#define FIT_RECORD_FIELD_NUM_FLOW (FIT_CAST(FIT_RECORD_FIELD_NUM, 115))
#define FIT_RECORD_FIELD_NUM_AIR_TIME_REMAINING (FIT_CAST(FIT_RECORD_FIELD_NUM, 123))
#define FIT_RECORD_FIELD_NUM_ASCENT_RATE (FIT_CAST(FIT_RECORD_FIELD_NUM, 127))
...
#define FIT_RECORD_FIELD_NUM_MOTOR_POWER (FIT_CAST(FIT_RECORD_FIELD_NUM, 82))
#define FIT_RECORD_FIELD_NUM_VERTICAL_RATIO (FIT_CAST(FIT_RECORD_FIELD_NUM, 83))
#define FIT_RECORD_FIELD_NUM_STANCE_TIME_BALANCE (FIT_CAST(FIT_RECORD_FIELD_NUM, 84))
#define FIT_RECORD_FIELD_NUM_STEP_LENGTH (FIT_CAST(FIT_RECORD_FIELD_NUM, 85))
#define FIT_RECORD_FIELD_NUM_CYCLE_LENGTH16 (FIT_CAST(FIT_RECORD_FIELD_NUM, 87))
#define FIT_RECORD_FIELD_NUM_N2_LOAD (FIT_CAST(FIT_RECORD_FIELD_NUM, 98))
#define FIT_RECORD_FIELD_NUM_ENHANCED_RESPIRATION_RATE (FIT_CAST(FIT_RECORD_FIELD_NUM, 108))
#define FIT_RECORD_FIELD_NUM_CURRENT_STRESS (FIT_CAST(FIT_RECORD_FIELD_NUM, 116))
#define FIT_RECORD_FIELD_NUM_EBIKE_TRAVEL_RANGE (FIT_CAST(FIT_RECORD_FIELD_NUM, 117))
#define FIT_RECORD_FIELD_NUM_PRESSURE_SAC (FIT_CAST(FIT_RECORD_FIELD_NUM, 124))
#define FIT_RECORD_FIELD_NUM_VOLUME_SAC (FIT_CAST(FIT_RECORD_FIELD_NUM, 125))
#define FIT_RECORD_FIELD_NUM_RMV (FIT_CAST(FIT_RECORD_FIELD_NUM, 126))
#define FIT_RECORD_FIELD_NUM_CORE_TEMPERATURE (FIT_CAST(FIT_RECORD_FIELD_NUM, 139))
...
#define FIT_RECORD_FIELD_NUM_LEFT_PCO (FIT_CAST(FIT_RECORD_FIELD_NUM, 67))
#define FIT_RECORD_FIELD_NUM_RIGHT_PCO (FIT_CAST(FIT_RECORD_FIELD_NUM, 68))
#define FIT_RECORD_FIELD_NUM_LEFT_POWER_PHASE (FIT_CAST(FIT_RECORD_FIELD_NUM, 69))
#define FIT_RECORD_FIELD_NUM_LEFT_POWER_PHASE_PEAK (FIT_CAST(FIT_RECORD_FIELD_NUM, 70))
#define FIT_RECORD_FIELD_NUM_RIGHT_POWER_PHASE (FIT_CAST(FIT_RECORD_FIELD_NUM, 71))
#define FIT_RECORD_FIELD_NUM_RIGHT_POWER_PHASE_PEAK (FIT_CAST(FIT_RECORD_FIELD_NUM, 72))
#define FIT_RECORD_FIELD_NUM_BATTERY_SOC (FIT_CAST(FIT_RECORD_FIELD_NUM, 81))
#define FIT_RECORD_FIELD_NUM_CNS_LOAD (FIT_CAST(FIT_RECORD_FIELD_NUM, 97))
#define FIT_RECORD_FIELD_NUM_RESPIRATION_RATE (FIT_CAST(FIT_RECORD_FIELD_NUM, 99))
#define FIT_RECORD_FIELD_NUM_EBIKE_BATTERY_LEVEL (FIT_CAST(FIT_RECORD_FIELD_NUM, 118))
#define FIT_RECORD_FIELD_NUM_EBIKE_ASSIST_MODE (FIT_CAST(FIT_RECORD_FIELD_NUM, 119))
#define FIT_RECORD_FIELD_NUM_EBIKE_ASSIST_LEVEL_PERCENT (FIT_CAST(FIT_RECORD_FIELD_NUM, 120))
#define FIT_RECORD_FIELD_NUM_PO2 (FIT_CAST(FIT_RECORD_FIELD_NUM, 129))
...
typedef enum
{
   ...
   FIT_RECORD_MESG_AIR_TIME_REMAINING,
   FIT_RECORD_MESG_ASCENT_RATE,
   ...
   FIT_RECORD_MESG_CYCLE_LENGTH16,
   FIT_RECORD_MESG_N2_LOAD,
   FIT_RECORD_MESG_ENHANCED_RESPIRATION_RATE,
   FIT_RECORD_MESG_CURRENT_STRESS,
   FIT_RECORD_MESG_EBIKE_TRAVEL_RANGE,
   FIT_RECORD_MESG_PRESSURE_SAC,
   FIT_RECORD_MESG_VOLUME_SAC,
   FIT_RECORD_MESG_RMV,
   ...
   FIT_RECORD_MESG_EBIKE_ASSIST_LEVEL_PERCENT,
   FIT_RECORD_MESG_PO2,
...
// event message
#define FIT_EVENT_MESG_SIZE                                                     31
#define FIT_EVENT_MESG_DEF_SIZE                                                 62

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT32 data; //
   FIT_DATE_TIME start_timestamp; // 1 * s + 0, Timestamp of when the event started
   FIT_UINT16 data16; //
   ...
   FIT_DEVICE_INDEX device_index; //
   FIT_ACTIVITY_TYPE activity_type; // Activity Type associated with an auto_activity_detect event
...
#define FIT_EVENT_FIELD_NUM_START_TIMESTAMP (FIT_CAST(FIT_EVENT_FIELD_NUM, 15))
...
#define FIT_EVENT_FIELD_NUM_DEVICE_INDEX (FIT_CAST(FIT_EVENT_FIELD_NUM, 13))
#define FIT_EVENT_FIELD_NUM_ACTIVITY_TYPE (FIT_CAST(FIT_EVENT_FIELD_NUM, 14))
...
#define FIT_EVENT_FIELD_NUM_RADAR_THREAT_AVG_APPROACH_SPEED (FIT_CAST(FIT_EVENT_FIELD_NUM, 23))
#define FIT_EVENT_FIELD_NUM_RADAR_THREAT_MAX_APPROACH_SPEED (FIT_CAST(FIT_EVENT_FIELD_NUM, 24))

typedef enum
{
   FIT_EVENT_MESG_TIMESTAMP,
   FIT_EVENT_MESG_DATA,
   FIT_EVENT_MESG_START_TIMESTAMP,
...
#define FIT_DEVICE_INFO_FIELD_NUM_BATTERY_LEVEL (FIT_CAST(FIT_DEVICE_INFO_FIELD_NUM, 32))
...
#define FIT_WEATHER_CONDITIONS_MESG_SIZE                                        30
#define FIT_WEATHER_CONDITIONS_MESG_DEF_SIZE                                    53
#define FIT_WEATHER_CONDITIONS_MESG_LOCATION_COUNT                              1
...
#define FIT_WEATHER_ALERT_MESG_SIZE                                             15
#define FIT_WEATHER_ALERT_MESG_DEF_SIZE                                         23
#define FIT_WEATHER_ALERT_MESG_REPORT_ID_COUNT                                  1
...
#define FIT_GPS_METADATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 253))
#define FIT_GPS_METADATA_FIELD_NUM_POSITION_LAT (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 1))
#define FIT_GPS_METADATA_FIELD_NUM_POSITION_LONG (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 2))
#define FIT_GPS_METADATA_FIELD_NUM_ENHANCED_ALTITUDE (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 3))
#define FIT_GPS_METADATA_FIELD_NUM_ENHANCED_SPEED (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 4))
#define FIT_GPS_METADATA_FIELD_NUM_UTC_TIMESTAMP (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 6))
#define FIT_GPS_METADATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 0))
#define FIT_GPS_METADATA_FIELD_NUM_HEADING (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 5))
#define FIT_GPS_METADATA_FIELD_NUM_VELOCITY (FIT_CAST(FIT_GPS_METADATA_FIELD_NUM, 7))
...
#define FIT_CAMERA_EVENT_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_CAMERA_EVENT_FIELD_NUM, 253))
#define FIT_CAMERA_EVENT_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_CAMERA_EVENT_FIELD_NUM, 0))
#define FIT_CAMERA_EVENT_FIELD_NUM_CAMERA_EVENT_TYPE (FIT_CAST(FIT_CAMERA_EVENT_FIELD_NUM, 1))
#define FIT_CAMERA_EVENT_FIELD_NUM_CAMERA_FILE_UUID (FIT_CAST(FIT_CAMERA_EVENT_FIELD_NUM, 2))
#define FIT_CAMERA_EVENT_FIELD_NUM_CAMERA_ORIENTATION (FIT_CAST(FIT_CAMERA_EVENT_FIELD_NUM, 3))
...
#define FIT_GYROSCOPE_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 253))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_CALIBRATED_GYRO_X (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 5))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_CALIBRATED_GYRO_Y (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 6))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_CALIBRATED_GYRO_Z (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 7))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 0))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_SAMPLE_TIME_OFFSET (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 1))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_GYRO_X (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 2))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_GYRO_Y (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 3))
#define FIT_GYROSCOPE_DATA_FIELD_NUM_GYRO_Z (FIT_CAST(FIT_GYROSCOPE_DATA_FIELD_NUM, 4))
...
#define FIT_ACCELEROMETER_DATA_MESG_DEF_SIZE                                    41
#define FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_X_COUNT                    1
#define FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_Y_COUNT                    1
#define FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_Z_COUNT                    1
...
#define FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_X_COUNT         1
#define FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_Y_COUNT         1
#define FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_Z_COUNT         1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0, Whole second part of the timestamp
   FIT_FLOAT32 calibrated_accel_x[FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_X_COUNT]; // 1 * g + 0, Calibrated accel reading
   FIT_FLOAT32 calibrated_accel_y[FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_Y_COUNT]; // 1 * g + 0, Calibrated accel reading
   FIT_FLOAT32 calibrated_accel_z[FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_Z_COUNT]; // 1 * g + 0, Calibrated accel reading
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Millisecond part of the timestamp.
   ...
   FIT_SINT16 compressed_calibrated_accel_x[FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_X_COUNT]; // 1 * mG + 0, Calibrated accel reading
   FIT_SINT16 compressed_calibrated_accel_y[FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_Y_COUNT]; // 1 * mG + 0, Calibrated accel reading
   FIT_SINT16 compressed_calibrated_accel_z[FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_Z_COUNT]; // 1 * mG + 0, Calibrated accel reading
} FIT_ACCELEROMETER_DATA_MESG;

typedef FIT_UINT8 FIT_ACCELEROMETER_DATA_FIELD_NUM;

#define FIT_ACCELEROMETER_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 253))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_CALIBRATED_ACCEL_X (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 5))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_CALIBRATED_ACCEL_Y (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 6))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_CALIBRATED_ACCEL_Z (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 7))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 0))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_SAMPLE_TIME_OFFSET (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 1))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_ACCEL_X (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 2))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_ACCEL_Y (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 3))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_ACCEL_Z (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 4))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_COMPRESSED_CALIBRATED_ACCEL_X (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 8))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_COMPRESSED_CALIBRATED_ACCEL_Y (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 9))
#define FIT_ACCELEROMETER_DATA_FIELD_NUM_COMPRESSED_CALIBRATED_ACCEL_Z (FIT_CAST(FIT_ACCELEROMETER_DATA_FIELD_NUM, 10))

typedef enum
{
   FIT_ACCELEROMETER_DATA_MESG_TIMESTAMP,
   FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_X,
   FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_Y,
   FIT_ACCELEROMETER_DATA_MESG_CALIBRATED_ACCEL_Z,
   ...
   FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_X,
   FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_Y,
   FIT_ACCELEROMETER_DATA_MESG_COMPRESSED_CALIBRATED_ACCEL_Z,
...
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 253))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_CALIBRATED_MAG_X (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 5))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_CALIBRATED_MAG_Y (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 6))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_CALIBRATED_MAG_Z (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 7))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 0))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_SAMPLE_TIME_OFFSET (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 1))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_MAG_X (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 2))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_MAG_Y (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 3))
#define FIT_MAGNETOMETER_DATA_FIELD_NUM_MAG_Z (FIT_CAST(FIT_MAGNETOMETER_DATA_FIELD_NUM, 4))
...
#define FIT_BAROMETER_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_BAROMETER_DATA_FIELD_NUM, 253))
#define FIT_BAROMETER_DATA_FIELD_NUM_BARO_PRES (FIT_CAST(FIT_BAROMETER_DATA_FIELD_NUM, 2))
#define FIT_BAROMETER_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_BAROMETER_DATA_FIELD_NUM, 0))
#define FIT_BAROMETER_DATA_FIELD_NUM_SAMPLE_TIME_OFFSET (FIT_CAST(FIT_BAROMETER_DATA_FIELD_NUM, 1))
...
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 253))
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_CALIBRATION_FACTOR (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 1))
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_CALIBRATION_DIVISOR (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 2))
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_LEVEL_SHIFT (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 3))
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_OFFSET_CAL (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 4))
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_ORIENTATION_MATRIX (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 5))
#define FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM_SENSOR_TYPE (FIT_CAST(FIT_THREE_D_SENSOR_CALIBRATION_FIELD_NUM, 0))
...
#define FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM, 253))
#define FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM_CALIBRATION_FACTOR (FIT_CAST(FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM, 1))
#define FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM_CALIBRATION_DIVISOR (FIT_CAST(FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM, 2))
#define FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM_LEVEL_SHIFT (FIT_CAST(FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM, 3))
#define FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM_OFFSET_CAL (FIT_CAST(FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM, 4))
#define FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM_SENSOR_TYPE (FIT_CAST(FIT_ONE_D_SENSOR_CALIBRATION_FIELD_NUM, 0))
...
#define FIT_VIDEO_FRAME_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_VIDEO_FRAME_FIELD_NUM, 253))
#define FIT_VIDEO_FRAME_FIELD_NUM_FRAME_NUMBER (FIT_CAST(FIT_VIDEO_FRAME_FIELD_NUM, 1))
#define FIT_VIDEO_FRAME_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_VIDEO_FRAME_FIELD_NUM, 0))
...
#define FIT_OBDII_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 253))
#define FIT_OBDII_DATA_FIELD_NUM_SYSTEM_TIME (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 5))
#define FIT_OBDII_DATA_FIELD_NUM_START_TIMESTAMP (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 6))
#define FIT_OBDII_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 0))
#define FIT_OBDII_DATA_FIELD_NUM_TIME_OFFSET (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 1))
#define FIT_OBDII_DATA_FIELD_NUM_START_TIMESTAMP_MS (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 7))
#define FIT_OBDII_DATA_FIELD_NUM_PID (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 2))
#define FIT_OBDII_DATA_FIELD_NUM_RAW_DATA (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 3))
#define FIT_OBDII_DATA_FIELD_NUM_PID_DATA_SIZE (FIT_CAST(FIT_OBDII_DATA_FIELD_NUM, 4))
...
#define FIT_NMEA_SENTENCE_MESG_SIZE                                             7
#define FIT_NMEA_SENTENCE_MESG_DEF_SIZE                                         14
#define FIT_NMEA_SENTENCE_MESG_SENTENCE_COUNT                                   1
...
#define FIT_VIDEO_FIELD_NUM_DURATION (FIT_CAST(FIT_VIDEO_FIELD_NUM, 2))
#define FIT_VIDEO_FIELD_NUM_URL (FIT_CAST(FIT_VIDEO_FIELD_NUM, 0))
#define FIT_VIDEO_FIELD_NUM_HOSTING_PROVIDER (FIT_CAST(FIT_VIDEO_FIELD_NUM, 1))
...
// video_title message
#define FIT_VIDEO_TITLE_MESG_SIZE                                               5
#define FIT_VIDEO_TITLE_MESG_DEF_SIZE                                           14
#define FIT_VIDEO_TITLE_MESG_TEXT_COUNT                                         1
...
#define FIT_VIDEO_DESCRIPTION_MESG_SIZE                                         5
#define FIT_VIDEO_DESCRIPTION_MESG_DEF_SIZE                                     14
#define FIT_VIDEO_DESCRIPTION_MESG_TEXT_COUNT                                   1
...
#define FIT_VIDEO_CLIP_FIELD_NUM_START_TIMESTAMP (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 1))
#define FIT_VIDEO_CLIP_FIELD_NUM_END_TIMESTAMP (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 3))
#define FIT_VIDEO_CLIP_FIELD_NUM_CLIP_START (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 6))
#define FIT_VIDEO_CLIP_FIELD_NUM_CLIP_END (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 7))
#define FIT_VIDEO_CLIP_FIELD_NUM_CLIP_NUMBER (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 0))
#define FIT_VIDEO_CLIP_FIELD_NUM_START_TIMESTAMP_MS (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 2))
#define FIT_VIDEO_CLIP_FIELD_NUM_END_TIMESTAMP_MS (FIT_CAST(FIT_VIDEO_CLIP_FIELD_NUM, 4))
...
#define FIT_SET_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_SET_FIELD_NUM, 254))
#define FIT_SET_FIELD_NUM_DURATION (FIT_CAST(FIT_SET_FIELD_NUM, 0))
#define FIT_SET_FIELD_NUM_START_TIME (FIT_CAST(FIT_SET_FIELD_NUM, 6))
#define FIT_SET_FIELD_NUM_REPETITIONS (FIT_CAST(FIT_SET_FIELD_NUM, 3))
#define FIT_SET_FIELD_NUM_WEIGHT (FIT_CAST(FIT_SET_FIELD_NUM, 4))
#define FIT_SET_FIELD_NUM_CATEGORY (FIT_CAST(FIT_SET_FIELD_NUM, 7))
#define FIT_SET_FIELD_NUM_CATEGORY_SUBTYPE (FIT_CAST(FIT_SET_FIELD_NUM, 8))
#define FIT_SET_FIELD_NUM_WEIGHT_DISPLAY_UNIT (FIT_CAST(FIT_SET_FIELD_NUM, 9))
#define FIT_SET_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_SET_FIELD_NUM, 10))
#define FIT_SET_FIELD_NUM_WKT_STEP_INDEX (FIT_CAST(FIT_SET_FIELD_NUM, 11))
#define FIT_SET_FIELD_NUM_SET_TYPE (FIT_CAST(FIT_SET_FIELD_NUM, 5))
...
#define FIT_JUMP_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_JUMP_FIELD_NUM, 253))
#define FIT_JUMP_FIELD_NUM_DISTANCE (FIT_CAST(FIT_JUMP_FIELD_NUM, 0))
#define FIT_JUMP_FIELD_NUM_HEIGHT (FIT_CAST(FIT_JUMP_FIELD_NUM, 1))
#define FIT_JUMP_FIELD_NUM_HANG_TIME (FIT_CAST(FIT_JUMP_FIELD_NUM, 3))
#define FIT_JUMP_FIELD_NUM_SCORE (FIT_CAST(FIT_JUMP_FIELD_NUM, 4))
#define FIT_JUMP_FIELD_NUM_POSITION_LAT (FIT_CAST(FIT_JUMP_FIELD_NUM, 5))
#define FIT_JUMP_FIELD_NUM_POSITION_LONG (FIT_CAST(FIT_JUMP_FIELD_NUM, 6))
#define FIT_JUMP_FIELD_NUM_ENHANCED_SPEED (FIT_CAST(FIT_JUMP_FIELD_NUM, 8))
#define FIT_JUMP_FIELD_NUM_SPEED (FIT_CAST(FIT_JUMP_FIELD_NUM, 7))
#define FIT_JUMP_FIELD_NUM_ROTATIONS (FIT_CAST(FIT_JUMP_FIELD_NUM, 2))
...
// split message
#define FIT_SPLIT_MESG_SIZE                                                     71
#define FIT_SPLIT_MESG_DEF_SIZE                                                 65
...
typedef struct
{
   ...
   FIT_UINT32 total_timer_time; // 1000 * s + 0,
   FIT_UINT32 total_distance; // 100 * m + 0,
   FIT_UINT32 avg_speed; // 1000 * m/s + 0,
   FIT_DATE_TIME start_time; //
   FIT_SINT32 start_position_lat; // 1 * semicircles + 0,
   FIT_SINT32 start_position_long; // 1 * semicircles + 0,
   FIT_SINT32 end_position_lat; // 1 * semicircles + 0,
   FIT_SINT32 end_position_long; // 1 * semicircles + 0,
   FIT_UINT32 max_speed; // 1000 * m/s + 0,
   FIT_SINT32 avg_vert_speed; // 1000 * m/s + 0,
   FIT_DATE_TIME end_time; //
   FIT_UINT32 total_calories; // 1 * kcal + 0,
   FIT_UINT32 start_elevation; // 5 * m + 500,
   FIT_UINT32 active_time; // 1000 * s + 0, Active time of split rounds
   FIT_UINT32 total_moving_time; // 1000 * s + 0,
   FIT_MESSAGE_INDEX message_index; //
   FIT_UINT16 total_ascent; // 1 * m + 0,
   FIT_UINT16 total_descent; // 1 * m + 0,
...
typedef FIT_UINT8 FIT_SPLIT_FIELD_NUM;

#define FIT_SPLIT_FIELD_NUM_TOTAL_ELAPSED_TIME (FIT_CAST(FIT_SPLIT_FIELD_NUM, 1))
#define FIT_SPLIT_FIELD_NUM_TOTAL_TIMER_TIME (FIT_CAST(FIT_SPLIT_FIELD_NUM, 2))
#define FIT_SPLIT_FIELD_NUM_TOTAL_DISTANCE (FIT_CAST(FIT_SPLIT_FIELD_NUM, 3))
#define FIT_SPLIT_FIELD_NUM_AVG_SPEED (FIT_CAST(FIT_SPLIT_FIELD_NUM, 4))
#define FIT_SPLIT_FIELD_NUM_START_TIME (FIT_CAST(FIT_SPLIT_FIELD_NUM, 9))
#define FIT_SPLIT_FIELD_NUM_START_POSITION_LAT (FIT_CAST(FIT_SPLIT_FIELD_NUM, 21))
#define FIT_SPLIT_FIELD_NUM_START_POSITION_LONG (FIT_CAST(FIT_SPLIT_FIELD_NUM, 22))
#define FIT_SPLIT_FIELD_NUM_END_POSITION_LAT (FIT_CAST(FIT_SPLIT_FIELD_NUM, 23))
#define FIT_SPLIT_FIELD_NUM_END_POSITION_LONG (FIT_CAST(FIT_SPLIT_FIELD_NUM, 24))
#define FIT_SPLIT_FIELD_NUM_MAX_SPEED (FIT_CAST(FIT_SPLIT_FIELD_NUM, 25))
#define FIT_SPLIT_FIELD_NUM_AVG_VERT_SPEED (FIT_CAST(FIT_SPLIT_FIELD_NUM, 26))
#define FIT_SPLIT_FIELD_NUM_END_TIME (FIT_CAST(FIT_SPLIT_FIELD_NUM, 27))
#define FIT_SPLIT_FIELD_NUM_TOTAL_CALORIES (FIT_CAST(FIT_SPLIT_FIELD_NUM, 28))
#define FIT_SPLIT_FIELD_NUM_START_ELEVATION (FIT_CAST(FIT_SPLIT_FIELD_NUM, 74))
#define FIT_SPLIT_FIELD_NUM_ACTIVE_TIME (FIT_CAST(FIT_SPLIT_FIELD_NUM, 78))
#define FIT_SPLIT_FIELD_NUM_TOTAL_MOVING_TIME (FIT_CAST(FIT_SPLIT_FIELD_NUM, 110))
#define FIT_SPLIT_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_SPLIT_FIELD_NUM, 254))
#define FIT_SPLIT_FIELD_NUM_TOTAL_ASCENT (FIT_CAST(FIT_SPLIT_FIELD_NUM, 13))
#define FIT_SPLIT_FIELD_NUM_TOTAL_DESCENT (FIT_CAST(FIT_SPLIT_FIELD_NUM, 14))
#define FIT_SPLIT_FIELD_NUM_SPLIT_TYPE (FIT_CAST(FIT_SPLIT_FIELD_NUM, 0))

typedef enum
{
   FIT_SPLIT_MESG_TOTAL_ELAPSED_TIME,
   FIT_SPLIT_MESG_TOTAL_TIMER_TIME,
   FIT_SPLIT_MESG_TOTAL_DISTANCE,
   FIT_SPLIT_MESG_AVG_SPEED,
   FIT_SPLIT_MESG_START_TIME,
   FIT_SPLIT_MESG_START_POSITION_LAT,
   FIT_SPLIT_MESG_START_POSITION_LONG,
   FIT_SPLIT_MESG_END_POSITION_LAT,
   FIT_SPLIT_MESG_END_POSITION_LONG,
   FIT_SPLIT_MESG_MAX_SPEED,
   FIT_SPLIT_MESG_AVG_VERT_SPEED,
   FIT_SPLIT_MESG_END_TIME,
   FIT_SPLIT_MESG_TOTAL_CALORIES,
   FIT_SPLIT_MESG_START_ELEVATION,
   FIT_SPLIT_MESG_ACTIVE_TIME,
   FIT_SPLIT_MESG_TOTAL_MOVING_TIME,
   FIT_SPLIT_MESG_MESSAGE_INDEX,
   FIT_SPLIT_MESG_TOTAL_ASCENT,
   FIT_SPLIT_MESG_TOTAL_DESCENT,
   FIT_SPLIT_MESG_SPLIT_TYPE,
   FIT_SPLIT_MESG_FIELDS
} FIT_SPLIT_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SPLIT_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SPLIT_MESG_DEF;

// split_summary message
#define FIT_SPLIT_SUMMARY_MESG_SIZE                                             43
#define FIT_SPLIT_SUMMARY_MESG_DEF_SIZE                                         50
...
typedef struct
{
   ...
   FIT_SINT32 avg_vert_speed; // 1000 * m/s + 0,
   FIT_UINT32 total_calories; // 1 * kcal + 0,
   FIT_UINT32 active_time; // 1000 * s + 0, total active time in all split rounds
   FIT_UINT32 total_moving_time; // 1000 * s + 0,
   FIT_MESSAGE_INDEX message_index; //
   FIT_UINT16 num_splits; //
   FIT_UINT16 total_ascent; // 1 * m + 0,
   FIT_UINT16 total_descent; // 1 * m + 0,
   FIT_SPLIT_TYPE split_type; //
   FIT_UINT8 avg_heart_rate; // 1 * bpm + 0,
   FIT_UINT8 max_heart_rate; // 1 * bpm + 0,
} FIT_SPLIT_SUMMARY_MESG;

typedef FIT_UINT8 FIT_SPLIT_SUMMARY_FIELD_NUM;

#define FIT_SPLIT_SUMMARY_FIELD_NUM_TOTAL_TIMER_TIME (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 4))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_TOTAL_DISTANCE (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 5))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_AVG_SPEED (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 6))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_MAX_SPEED (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 7))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_AVG_VERT_SPEED (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 12))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_TOTAL_CALORIES (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 13))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_ACTIVE_TIME (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 65))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_TOTAL_MOVING_TIME (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 77))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 254))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_NUM_SPLITS (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 3))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_TOTAL_ASCENT (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 8))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_TOTAL_DESCENT (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 9))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_SPLIT_TYPE (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 0))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_AVG_HEART_RATE (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 10))
#define FIT_SPLIT_SUMMARY_FIELD_NUM_MAX_HEART_RATE (FIT_CAST(FIT_SPLIT_SUMMARY_FIELD_NUM, 11))

typedef enum
{
   FIT_SPLIT_SUMMARY_MESG_TOTAL_TIMER_TIME,
   FIT_SPLIT_SUMMARY_MESG_TOTAL_DISTANCE,
   FIT_SPLIT_SUMMARY_MESG_AVG_SPEED,
   FIT_SPLIT_SUMMARY_MESG_MAX_SPEED,
   FIT_SPLIT_SUMMARY_MESG_AVG_VERT_SPEED,
   FIT_SPLIT_SUMMARY_MESG_TOTAL_CALORIES,
   FIT_SPLIT_SUMMARY_MESG_ACTIVE_TIME,
   FIT_SPLIT_SUMMARY_MESG_TOTAL_MOVING_TIME,
   FIT_SPLIT_SUMMARY_MESG_MESSAGE_INDEX,
   FIT_SPLIT_SUMMARY_MESG_NUM_SPLITS,
   FIT_SPLIT_SUMMARY_MESG_TOTAL_ASCENT,
   FIT_SPLIT_SUMMARY_MESG_TOTAL_DESCENT,
   FIT_SPLIT_SUMMARY_MESG_SPLIT_TYPE,
   FIT_SPLIT_SUMMARY_MESG_AVG_HEART_RATE,
   FIT_SPLIT_SUMMARY_MESG_MAX_HEART_RATE,
   FIT_SPLIT_SUMMARY_MESG_FIELDS
} FIT_SPLIT_SUMMARY_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SPLIT_SUMMARY_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SPLIT_SUMMARY_MESG_DEF;
...
#define FIT_CLIMB_PRO_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 253))
#define FIT_CLIMB_PRO_FIELD_NUM_POSITION_LAT (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 0))
#define FIT_CLIMB_PRO_FIELD_NUM_POSITION_LONG (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 1))
#define FIT_CLIMB_PRO_FIELD_NUM_CURRENT_DIST (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 5))
#define FIT_CLIMB_PRO_FIELD_NUM_CLIMB_NUMBER (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 3))
#define FIT_CLIMB_PRO_FIELD_NUM_CLIMB_PRO_EVENT (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 2))
#define FIT_CLIMB_PRO_FIELD_NUM_CLIMB_CATEGORY (FIT_CAST(FIT_CLIMB_PRO_FIELD_NUM, 4))
...
#define FIT_FIELD_DESCRIPTION_MESG_SIZE                                         16
#define FIT_FIELD_DESCRIPTION_MESG_DEF_SIZE                                     47
#define FIT_FIELD_DESCRIPTION_MESG_FIELD_NAME_COUNT                             1
#define FIT_FIELD_DESCRIPTION_MESG_COMPONENTS_COUNT                             1
#define FIT_FIELD_DESCRIPTION_MESG_UNITS_COUNT                                  1
...
#define FIT_FIELD_DESCRIPTION_FIELD_NUM_ARRAY (FIT_CAST(FIT_FIELD_DESCRIPTION_FIELD_NUM, 4))
#define FIT_FIELD_DESCRIPTION_FIELD_NUM_COMPONENTS (FIT_CAST(FIT_FIELD_DESCRIPTION_FIELD_NUM, 5))
...
#define FIT_FIELD_DESCRIPTION_FIELD_NUM_BITS (FIT_CAST(FIT_FIELD_DESCRIPTION_FIELD_NUM, 9))
#define FIT_FIELD_DESCRIPTION_FIELD_NUM_ACCUMULATE (FIT_CAST(FIT_FIELD_DESCRIPTION_FIELD_NUM, 10))
...
#define FIT_DEVELOPER_DATA_ID_MESG_SIZE                                         9
#define FIT_DEVELOPER_DATA_ID_MESG_DEF_SIZE                                     20
#define FIT_DEVELOPER_DATA_ID_MESG_DEVELOPER_ID_COUNT                           1
#define FIT_DEVELOPER_DATA_ID_MESG_APPLICATION_ID_COUNT                         1
...
// course message
#define FIT_COURSE_MESG_SIZE                                                    7
#define FIT_COURSE_MESG_DEF_SIZE                                                17
#define FIT_COURSE_MESG_NAME_COUNT                                              1
...
#define FIT_COURSE_POINT_MESG_SIZE                                              21
#define FIT_COURSE_POINT_MESG_DEF_SIZE                                          29
#define FIT_COURSE_POINT_MESG_NAME_COUNT                                        1
...
#define FIT_SEGMENT_LEADERBOARD_ENTRY_FIELD_NUM_ACTIVITY_ID_STRING (FIT_CAST(FIT_SEGMENT_LEADERBOARD_ENTRY_FIELD_NUM, 5))
...
#define FIT_SEGMENT_POINT_MESG_SIZE                                             24
#define FIT_SEGMENT_POINT_MESG_DEF_SIZE                                         26
...
typedef struct
{
   ...
   FIT_UINT32 enhanced_altitude; // 5 * m + 500, Accumulated altitude along the segment at the described point
   FIT_MESSAGE_INDEX message_index; //
...
#define FIT_SEGMENT_POINT_FIELD_NUM_ENHANCED_ALTITUDE (FIT_CAST(FIT_SEGMENT_POINT_FIELD_NUM, 6))
...
typedef enum
{
   ...
   FIT_SEGMENT_POINT_MESG_ENHANCED_ALTITUDE,
...
// segment_lap message
#define FIT_SEGMENT_LAP_MESG_SIZE                                               213
#define FIT_SEGMENT_LAP_MESG_DEF_SIZE                                           290
...
#define FIT_SEGMENT_LAP_MESG_AVG_POWER_POSITION_COUNT                           1
#define FIT_SEGMENT_LAP_MESG_MAX_POWER_POSITION_COUNT                           1
#define FIT_SEGMENT_LAP_MESG_NAME_COUNT                                         1
#define FIT_SEGMENT_LAP_MESG_UUID_COUNT                                         1
#define FIT_SEGMENT_LAP_MESG_AVG_LEFT_POWER_PHASE_COUNT                         1
#define FIT_SEGMENT_LAP_MESG_AVG_LEFT_POWER_PHASE_PEAK_COUNT                    1
#define FIT_SEGMENT_LAP_MESG_AVG_RIGHT_POWER_PHASE_COUNT                        1
#define FIT_SEGMENT_LAP_MESG_AVG_RIGHT_POWER_PHASE_PEAK_COUNT                   1
#define FIT_SEGMENT_LAP_MESG_AVG_CADENCE_POSITION_COUNT                         1
#define FIT_SEGMENT_LAP_MESG_MAX_CADENCE_POSITION_COUNT                         1
...
#define FIT_SEGMENT_LAP_FIELD_NUM_TIME_STANDING (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 71))
#define FIT_SEGMENT_LAP_FIELD_NUM_TOTAL_GRIT (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 84))
#define FIT_SEGMENT_LAP_FIELD_NUM_TOTAL_FLOW (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 85))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_GRIT (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 86))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_FLOW (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 87))
#define FIT_SEGMENT_LAP_FIELD_NUM_ENHANCED_AVG_ALTITUDE (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 91))
#define FIT_SEGMENT_LAP_FIELD_NUM_ENHANCED_MAX_ALTITUDE (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 92))
#define FIT_SEGMENT_LAP_FIELD_NUM_ENHANCED_MIN_ALTITUDE (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 93))
...
#define FIT_SEGMENT_LAP_FIELD_NUM_STAND_COUNT (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 72))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_POWER_POSITION (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 79))
#define FIT_SEGMENT_LAP_FIELD_NUM_MAX_POWER_POSITION (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 80))
#define FIT_SEGMENT_LAP_FIELD_NUM_MANUFACTURER (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 83))
...
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_LEFT_PCO (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 73))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_RIGHT_PCO (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 74))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_LEFT_POWER_PHASE (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 75))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_LEFT_POWER_PHASE_PEAK (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 76))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_RIGHT_POWER_PHASE (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 77))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_RIGHT_POWER_PHASE_PEAK (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 78))
#define FIT_SEGMENT_LAP_FIELD_NUM_AVG_CADENCE_POSITION (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 81))
#define FIT_SEGMENT_LAP_FIELD_NUM_MAX_CADENCE_POSITION (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 82))
#define FIT_SEGMENT_LAP_FIELD_NUM_TOTAL_FRACTIONAL_ASCENT (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 89))
#define FIT_SEGMENT_LAP_FIELD_NUM_TOTAL_FRACTIONAL_DESCENT (FIT_CAST(FIT_SEGMENT_LAP_FIELD_NUM, 90))
...
typedef enum
{
   ...
   FIT_SEGMENT_LAP_MESG_ENHANCED_AVG_ALTITUDE,
   FIT_SEGMENT_LAP_MESG_ENHANCED_MAX_ALTITUDE,
   FIT_SEGMENT_LAP_MESG_ENHANCED_MIN_ALTITUDE,
...
#define FIT_SEGMENT_FILE_FIELD_NUM_LEADER_ACTIVITY_ID_STRING (FIT_CAST(FIT_SEGMENT_FILE_FIELD_NUM, 10))
#define FIT_SEGMENT_FILE_FIELD_NUM_DEFAULT_RACE_LEADER (FIT_CAST(FIT_SEGMENT_FILE_FIELD_NUM, 11))
...
// workout message
#define FIT_WORKOUT_MESG_SIZE                                                   15
#define FIT_WORKOUT_MESG_DEF_SIZE                                               32
#define FIT_WORKOUT_MESG_WKT_NAME_COUNT                                         1
#define FIT_WORKOUT_MESG_WKT_DESCRIPTION_COUNT                                  1
...
typedef struct
{
   ...
   FIT_SUB_SPORT sub_sport; //
   FIT_DISPLAY_MEASURE pool_length_unit; //
   FIT_STRING wkt_description[FIT_WORKOUT_MESG_WKT_DESCRIPTION_COUNT]; // Description of the workout
} FIT_WORKOUT_MESG;
...
#define FIT_WORKOUT_FIELD_NUM_WKT_DESCRIPTION (FIT_CAST(FIT_WORKOUT_FIELD_NUM, 17))
...
typedef enum
{
   ...
   FIT_WORKOUT_MESG_WKT_DESCRIPTION,
...
#define FIT_WORKOUT_STEP_MESG_SIZE                                              45
#define FIT_WORKOUT_STEP_MESG_DEF_SIZE                                          62
#define FIT_WORKOUT_STEP_MESG_WKT_STEP_NAME_COUNT                               1
#define FIT_WORKOUT_STEP_MESG_NOTES_COUNT                                       1
...
#define FIT_WORKOUT_STEP_FIELD_NUM_EXERCISE_NAME (FIT_CAST(FIT_WORKOUT_STEP_FIELD_NUM, 11))
#define FIT_WORKOUT_STEP_FIELD_NUM_EXERCISE_WEIGHT (FIT_CAST(FIT_WORKOUT_STEP_FIELD_NUM, 12))
#define FIT_WORKOUT_STEP_FIELD_NUM_WEIGHT_DISPLAY_UNIT (FIT_CAST(FIT_WORKOUT_STEP_FIELD_NUM, 13))
...
#define FIT_EXERCISE_TITLE_MESG_SIZE                                            7
#define FIT_EXERCISE_TITLE_MESG_DEF_SIZE                                        17
#define FIT_EXERCISE_TITLE_MESG_WKT_STEP_NAME_COUNT                             1
...
#define FIT_TOTALS_FIELD_NUM_SPORT_INDEX (FIT_CAST(FIT_TOTALS_FIELD_NUM, 9))
...
#define FIT_MONITORING_INFO_FIELD_NUM_CYCLES_TO_DISTANCE (FIT_CAST(FIT_MONITORING_INFO_FIELD_NUM, 3))
#define FIT_MONITORING_INFO_FIELD_NUM_CYCLES_TO_CALORIES (FIT_CAST(FIT_MONITORING_INFO_FIELD_NUM, 4))
#define FIT_MONITORING_INFO_FIELD_NUM_RESTING_METABOLIC_RATE (FIT_CAST(FIT_MONITORING_INFO_FIELD_NUM, 5))
#define FIT_MONITORING_INFO_FIELD_NUM_ACTIVITY_TYPE (FIT_CAST(FIT_MONITORING_INFO_FIELD_NUM, 1))
...
#define FIT_MONITORING_FIELD_NUM_ACTIVITY_TIME (FIT_CAST(FIT_MONITORING_FIELD_NUM, 16))
#define FIT_MONITORING_FIELD_NUM_DURATION (FIT_CAST(FIT_MONITORING_FIELD_NUM, 30))
#define FIT_MONITORING_FIELD_NUM_ASCENT (FIT_CAST(FIT_MONITORING_FIELD_NUM, 31))
#define FIT_MONITORING_FIELD_NUM_DESCENT (FIT_CAST(FIT_MONITORING_FIELD_NUM, 32))
...
#define FIT_MONITORING_FIELD_NUM_TEMPERATURE (FIT_CAST(FIT_MONITORING_FIELD_NUM, 12))
#define FIT_MONITORING_FIELD_NUM_TEMPERATURE_MIN (FIT_CAST(FIT_MONITORING_FIELD_NUM, 14))
#define FIT_MONITORING_FIELD_NUM_TEMPERATURE_MAX (FIT_CAST(FIT_MONITORING_FIELD_NUM, 15))
#define FIT_MONITORING_FIELD_NUM_ACTIVE_CALORIES (FIT_CAST(FIT_MONITORING_FIELD_NUM, 19))
#define FIT_MONITORING_FIELD_NUM_TIMESTAMP_16 (FIT_CAST(FIT_MONITORING_FIELD_NUM, 26))
#define FIT_MONITORING_FIELD_NUM_DURATION_MIN (FIT_CAST(FIT_MONITORING_FIELD_NUM, 29))
#define FIT_MONITORING_FIELD_NUM_MODERATE_ACTIVITY_MINUTES (FIT_CAST(FIT_MONITORING_FIELD_NUM, 33))
#define FIT_MONITORING_FIELD_NUM_VIGOROUS_ACTIVITY_MINUTES (FIT_CAST(FIT_MONITORING_FIELD_NUM, 34))
...
#define FIT_MONITORING_FIELD_NUM_ACTIVITY_LEVEL (FIT_CAST(FIT_MONITORING_FIELD_NUM, 7))
#define FIT_MONITORING_FIELD_NUM_CURRENT_ACTIVITY_TYPE_INTENSITY (FIT_CAST(FIT_MONITORING_FIELD_NUM, 24))
#define FIT_MONITORING_FIELD_NUM_TIMESTAMP_MIN_8 (FIT_CAST(FIT_MONITORING_FIELD_NUM, 25))
#define FIT_MONITORING_FIELD_NUM_HEART_RATE (FIT_CAST(FIT_MONITORING_FIELD_NUM, 27))
#define FIT_MONITORING_FIELD_NUM_INTENSITY (FIT_CAST(FIT_MONITORING_FIELD_NUM, 28))
...
// spo2_data message
#define FIT_SPO2_DATA_MESG_SIZE                                                 7
#define FIT_SPO2_DATA_MESG_DEF_SIZE                                             17

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT8 reading_spo2; // 1 * percent + 0,
   FIT_UINT8 reading_confidence; //
   FIT_SPO2_MEASUREMENT_TYPE mode; // Mode when data was captured
} FIT_SPO2_DATA_MESG;

typedef FIT_UINT8 FIT_SPO2_DATA_FIELD_NUM;

#define FIT_SPO2_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_SPO2_DATA_FIELD_NUM, 253))
#define FIT_SPO2_DATA_FIELD_NUM_READING_SPO2 (FIT_CAST(FIT_SPO2_DATA_FIELD_NUM, 0))
#define FIT_SPO2_DATA_FIELD_NUM_READING_CONFIDENCE (FIT_CAST(FIT_SPO2_DATA_FIELD_NUM, 1))
#define FIT_SPO2_DATA_FIELD_NUM_MODE (FIT_CAST(FIT_SPO2_DATA_FIELD_NUM, 2))

typedef enum
{
   FIT_SPO2_DATA_MESG_TIMESTAMP,
   FIT_SPO2_DATA_MESG_READING_SPO2,
   FIT_SPO2_DATA_MESG_READING_CONFIDENCE,
   FIT_SPO2_DATA_MESG_MODE,
   FIT_SPO2_DATA_MESG_FIELDS
} FIT_SPO2_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SPO2_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SPO2_DATA_MESG_DEF;
...
#define FIT_STRESS_LEVEL_FIELD_NUM_STRESS_LEVEL_TIME (FIT_CAST(FIT_STRESS_LEVEL_FIELD_NUM, 1))
#define FIT_STRESS_LEVEL_FIELD_NUM_STRESS_LEVEL_VALUE (FIT_CAST(FIT_STRESS_LEVEL_FIELD_NUM, 0))
...
// max_met_data message
#define FIT_MAX_MET_DATA_MESG_SIZE                                              12
#define FIT_MAX_MET_DATA_MESG_DEF_SIZE                                          29

typedef struct
{
   FIT_DATE_TIME update_time; // Time maxMET and vo2 were calculated
   FIT_UINT16 vo2_max; // 10 * mL/kg/min + 0,
   FIT_SPORT sport; //
   FIT_SUB_SPORT sub_sport; //
   FIT_MAX_MET_CATEGORY max_met_category; //
   FIT_BOOL calibrated_data; // Indicates if calibrated data was used in the calculation
   FIT_MAX_MET_HEART_RATE_SOURCE hr_source; // Indicates if the estimate was obtained using a chest strap or wrist heart rate
   FIT_MAX_MET_SPEED_SOURCE speed_source; // Indidcates if the estimate was obtained using onboard GPS or connected GPS
} FIT_MAX_MET_DATA_MESG;

typedef FIT_UINT8 FIT_MAX_MET_DATA_FIELD_NUM;

#define FIT_MAX_MET_DATA_FIELD_NUM_UPDATE_TIME (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 0))
#define FIT_MAX_MET_DATA_FIELD_NUM_VO2_MAX (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 2))
#define FIT_MAX_MET_DATA_FIELD_NUM_SPORT (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 5))
#define FIT_MAX_MET_DATA_FIELD_NUM_SUB_SPORT (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 6))
#define FIT_MAX_MET_DATA_FIELD_NUM_MAX_MET_CATEGORY (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 8))
#define FIT_MAX_MET_DATA_FIELD_NUM_CALIBRATED_DATA (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 9))
#define FIT_MAX_MET_DATA_FIELD_NUM_HR_SOURCE (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 12))
#define FIT_MAX_MET_DATA_FIELD_NUM_SPEED_SOURCE (FIT_CAST(FIT_MAX_MET_DATA_FIELD_NUM, 13))

typedef enum
{
   FIT_MAX_MET_DATA_MESG_UPDATE_TIME,
   FIT_MAX_MET_DATA_MESG_VO2_MAX,
   FIT_MAX_MET_DATA_MESG_SPORT,
   FIT_MAX_MET_DATA_MESG_SUB_SPORT,
   FIT_MAX_MET_DATA_MESG_MAX_MET_CATEGORY,
   FIT_MAX_MET_DATA_MESG_CALIBRATED_DATA,
   FIT_MAX_MET_DATA_MESG_HR_SOURCE,
   FIT_MAX_MET_DATA_MESG_SPEED_SOURCE,
   FIT_MAX_MET_DATA_MESG_FIELDS
} FIT_MAX_MET_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_MAX_MET_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_MAX_MET_DATA_MESG_DEF;

// hsa_body_battery_data message
#define FIT_HSA_BODY_BATTERY_DATA_MESG_SIZE                                     11
#define FIT_HSA_BODY_BATTERY_DATA_MESG_DEF_SIZE                                 20
#define FIT_HSA_BODY_BATTERY_DATA_MESG_CHARGED_COUNT                            1
#define FIT_HSA_BODY_BATTERY_DATA_MESG_UNCHARGED_COUNT                          1
#define FIT_HSA_BODY_BATTERY_DATA_MESG_LEVEL_COUNT                              1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds
   FIT_SINT16 charged[FIT_HSA_BODY_BATTERY_DATA_MESG_CHARGED_COUNT]; // Body battery charged value
   FIT_SINT16 uncharged[FIT_HSA_BODY_BATTERY_DATA_MESG_UNCHARGED_COUNT]; // Body battery uncharged value
   FIT_SINT8 level[FIT_HSA_BODY_BATTERY_DATA_MESG_LEVEL_COUNT]; // 1 * percent + 0, Body battery level: [0,100] Blank: -16
} FIT_HSA_BODY_BATTERY_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM;

#define FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM, 253))
#define FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM, 0))
#define FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM_CHARGED (FIT_CAST(FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM, 2))
#define FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM_UNCHARGED (FIT_CAST(FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM, 3))
#define FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM_LEVEL (FIT_CAST(FIT_HSA_BODY_BATTERY_DATA_FIELD_NUM, 1))

typedef enum
{
   FIT_HSA_BODY_BATTERY_DATA_MESG_TIMESTAMP,
   FIT_HSA_BODY_BATTERY_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_BODY_BATTERY_DATA_MESG_CHARGED,
   FIT_HSA_BODY_BATTERY_DATA_MESG_UNCHARGED,
   FIT_HSA_BODY_BATTERY_DATA_MESG_LEVEL,
   FIT_HSA_BODY_BATTERY_DATA_MESG_FIELDS
} FIT_HSA_BODY_BATTERY_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_BODY_BATTERY_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_BODY_BATTERY_DATA_MESG_DEF;

// hsa_event message
#define FIT_HSA_EVENT_MESG_SIZE                                                 5
#define FIT_HSA_EVENT_MESG_DEF_SIZE                                             11

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT8 event_id; // Event ID. Health SDK use only
} FIT_HSA_EVENT_MESG;

typedef FIT_UINT8 FIT_HSA_EVENT_FIELD_NUM;

#define FIT_HSA_EVENT_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_EVENT_FIELD_NUM, 253))
#define FIT_HSA_EVENT_FIELD_NUM_EVENT_ID (FIT_CAST(FIT_HSA_EVENT_FIELD_NUM, 0))

typedef enum
{
   FIT_HSA_EVENT_MESG_TIMESTAMP,
   FIT_HSA_EVENT_MESG_EVENT_ID,
   FIT_HSA_EVENT_MESG_FIELDS
} FIT_HSA_EVENT_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_EVENT_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_EVENT_MESG_DEF;

// hsa_accelerometer_data message
#define FIT_HSA_ACCELEROMETER_DATA_MESG_SIZE                                    18
#define FIT_HSA_ACCELEROMETER_DATA_MESG_DEF_SIZE                                26
#define FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_X_COUNT                           1
#define FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_Y_COUNT                           1
#define FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_Z_COUNT                           1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT32 timestamp_32k; // 32 kHz timestamp
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Millisecond resolution of the timestamp
   FIT_UINT16 sampling_interval; // 1 * ms + 0, Sampling Interval in Milliseconds
   FIT_SINT16 accel_x[FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_X_COUNT]; // 1.024 * mG + 0, X-Axis Measurement
   FIT_SINT16 accel_y[FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_Y_COUNT]; // 1.024 * mG + 0, Y-Axis Measurement
   FIT_SINT16 accel_z[FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_Z_COUNT]; // 1.024 * mG + 0, Z-Axis Measurement
} FIT_HSA_ACCELEROMETER_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM;

#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 253))
#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_TIMESTAMP_32K (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 5))
#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 0))
#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_SAMPLING_INTERVAL (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 1))
#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_ACCEL_X (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 2))
#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_ACCEL_Y (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 3))
#define FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM_ACCEL_Z (FIT_CAST(FIT_HSA_ACCELEROMETER_DATA_FIELD_NUM, 4))

typedef enum
{
   FIT_HSA_ACCELEROMETER_DATA_MESG_TIMESTAMP,
   FIT_HSA_ACCELEROMETER_DATA_MESG_TIMESTAMP_32K,
   FIT_HSA_ACCELEROMETER_DATA_MESG_TIMESTAMP_MS,
   FIT_HSA_ACCELEROMETER_DATA_MESG_SAMPLING_INTERVAL,
   FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_X,
   FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_Y,
   FIT_HSA_ACCELEROMETER_DATA_MESG_ACCEL_Z,
   FIT_HSA_ACCELEROMETER_DATA_MESG_FIELDS
} FIT_HSA_ACCELEROMETER_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_ACCELEROMETER_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_ACCELEROMETER_DATA_MESG_DEF;

// hsa_gyroscope_data message
#define FIT_HSA_GYROSCOPE_DATA_MESG_SIZE                                        18
#define FIT_HSA_GYROSCOPE_DATA_MESG_DEF_SIZE                                    26
#define FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_X_COUNT                                1
#define FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_Y_COUNT                                1
#define FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_Z_COUNT                                1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT32 timestamp_32k; // 1 * 1/32768 s + 0, 32 kHz timestamp
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Millisecond resolution of the timestamp
   FIT_UINT16 sampling_interval; // 1 * 1/32768 s + 0, Sampling Interval in 32 kHz timescale
   FIT_SINT16 gyro_x[FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_X_COUNT]; // 28.57143 * deg/s + 0, X-Axis Measurement
   FIT_SINT16 gyro_y[FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_Y_COUNT]; // 28.57143 * deg/s + 0, Y-Axis Measurement
   FIT_SINT16 gyro_z[FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_Z_COUNT]; // 28.57143 * deg/s + 0, Z-Axis Measurement
} FIT_HSA_GYROSCOPE_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_GYROSCOPE_DATA_FIELD_NUM;

#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 253))
#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_TIMESTAMP_32K (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 5))
#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 0))
#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_SAMPLING_INTERVAL (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 1))
#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_GYRO_X (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 2))
#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_GYRO_Y (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 3))
#define FIT_HSA_GYROSCOPE_DATA_FIELD_NUM_GYRO_Z (FIT_CAST(FIT_HSA_GYROSCOPE_DATA_FIELD_NUM, 4))

typedef enum
{
   FIT_HSA_GYROSCOPE_DATA_MESG_TIMESTAMP,
   FIT_HSA_GYROSCOPE_DATA_MESG_TIMESTAMP_32K,
   FIT_HSA_GYROSCOPE_DATA_MESG_TIMESTAMP_MS,
   FIT_HSA_GYROSCOPE_DATA_MESG_SAMPLING_INTERVAL,
   FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_X,
   FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_Y,
   FIT_HSA_GYROSCOPE_DATA_MESG_GYRO_Z,
   FIT_HSA_GYROSCOPE_DATA_MESG_FIELDS
} FIT_HSA_GYROSCOPE_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_GYROSCOPE_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_GYROSCOPE_DATA_MESG_DEF;

// hsa_step_data message
#define FIT_HSA_STEP_DATA_MESG_SIZE                                             10
#define FIT_HSA_STEP_DATA_MESG_DEF_SIZE                                         14
#define FIT_HSA_STEP_DATA_MESG_STEPS_COUNT                                      1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT32 steps[FIT_HSA_STEP_DATA_MESG_STEPS_COUNT]; // 1 * steps + 0, Total step sum
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds. File start: 0xFFFFFFEF File stop: 0xFFFFFFEE
} FIT_HSA_STEP_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_STEP_DATA_FIELD_NUM;

#define FIT_HSA_STEP_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_STEP_DATA_FIELD_NUM, 253))
#define FIT_HSA_STEP_DATA_FIELD_NUM_STEPS (FIT_CAST(FIT_HSA_STEP_DATA_FIELD_NUM, 1))
#define FIT_HSA_STEP_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_STEP_DATA_FIELD_NUM, 0))

typedef enum
{
   FIT_HSA_STEP_DATA_MESG_TIMESTAMP,
   FIT_HSA_STEP_DATA_MESG_STEPS,
   FIT_HSA_STEP_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_STEP_DATA_MESG_FIELDS
} FIT_HSA_STEP_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_STEP_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_STEP_DATA_MESG_DEF;

// hsa_spo2_data message
#define FIT_HSA_SPO2_DATA_MESG_SIZE                                             8
#define FIT_HSA_SPO2_DATA_MESG_DEF_SIZE                                         17
#define FIT_HSA_SPO2_DATA_MESG_READING_SPO2_COUNT                               1
#define FIT_HSA_SPO2_DATA_MESG_CONFIDENCE_COUNT                                 1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds
   FIT_UINT8 reading_spo2[FIT_HSA_SPO2_DATA_MESG_READING_SPO2_COUNT]; // 1 * percent + 0, SpO2 Reading: [70,100] Blank: 240
   FIT_UINT8 confidence[FIT_HSA_SPO2_DATA_MESG_CONFIDENCE_COUNT]; // SpO2 Confidence: [0,254]
} FIT_HSA_SPO2_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_SPO2_DATA_FIELD_NUM;

#define FIT_HSA_SPO2_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_SPO2_DATA_FIELD_NUM, 253))
#define FIT_HSA_SPO2_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_SPO2_DATA_FIELD_NUM, 0))
#define FIT_HSA_SPO2_DATA_FIELD_NUM_READING_SPO2 (FIT_CAST(FIT_HSA_SPO2_DATA_FIELD_NUM, 1))
#define FIT_HSA_SPO2_DATA_FIELD_NUM_CONFIDENCE (FIT_CAST(FIT_HSA_SPO2_DATA_FIELD_NUM, 2))

typedef enum
{
   FIT_HSA_SPO2_DATA_MESG_TIMESTAMP,
   FIT_HSA_SPO2_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_SPO2_DATA_MESG_READING_SPO2,
   FIT_HSA_SPO2_DATA_MESG_CONFIDENCE,
   FIT_HSA_SPO2_DATA_MESG_FIELDS
} FIT_HSA_SPO2_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_SPO2_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_SPO2_DATA_MESG_DEF;

// hsa_stress_data message
#define FIT_HSA_STRESS_DATA_MESG_SIZE                                           7
#define FIT_HSA_STRESS_DATA_MESG_DEF_SIZE                                       14
#define FIT_HSA_STRESS_DATA_MESG_STRESS_LEVEL_COUNT                             1

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds
   FIT_SINT8 stress_level[FIT_HSA_STRESS_DATA_MESG_STRESS_LEVEL_COUNT]; // 1 * s + 0, Stress Level: [0,100] Off wrist: -1 Excess motion: -2 Not enough data: -3 Recovering from exercise: -4 Unidentified: -5 Blank: -16
} FIT_HSA_STRESS_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_STRESS_DATA_FIELD_NUM;

#define FIT_HSA_STRESS_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_STRESS_DATA_FIELD_NUM, 253))
#define FIT_HSA_STRESS_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_STRESS_DATA_FIELD_NUM, 0))
#define FIT_HSA_STRESS_DATA_FIELD_NUM_STRESS_LEVEL (FIT_CAST(FIT_HSA_STRESS_DATA_FIELD_NUM, 1))

typedef enum
{
   FIT_HSA_STRESS_DATA_MESG_TIMESTAMP,
   FIT_HSA_STRESS_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_STRESS_DATA_MESG_STRESS_LEVEL,
   FIT_HSA_STRESS_DATA_MESG_FIELDS
} FIT_HSA_STRESS_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_STRESS_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_STRESS_DATA_MESG_DEF;

// hsa_respiration_data message
#define FIT_HSA_RESPIRATION_DATA_MESG_SIZE                                      8
#define FIT_HSA_RESPIRATION_DATA_MESG_DEF_SIZE                                  14
#define FIT_HSA_RESPIRATION_DATA_MESG_RESPIRATION_RATE_COUNT                    1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds
   FIT_SINT16 respiration_rate[FIT_HSA_RESPIRATION_DATA_MESG_RESPIRATION_RATE_COUNT]; // 100 * breaths/min + 0, Breaths / min: [1,100] Invalid: 255 Excess motion: 254 Off wrist: 253 Not available: 252 Blank: 2.4
} FIT_HSA_RESPIRATION_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_RESPIRATION_DATA_FIELD_NUM;

#define FIT_HSA_RESPIRATION_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_RESPIRATION_DATA_FIELD_NUM, 253))
#define FIT_HSA_RESPIRATION_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_RESPIRATION_DATA_FIELD_NUM, 0))
#define FIT_HSA_RESPIRATION_DATA_FIELD_NUM_RESPIRATION_RATE (FIT_CAST(FIT_HSA_RESPIRATION_DATA_FIELD_NUM, 1))

typedef enum
{
   FIT_HSA_RESPIRATION_DATA_MESG_TIMESTAMP,
   FIT_HSA_RESPIRATION_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_RESPIRATION_DATA_MESG_RESPIRATION_RATE,
   FIT_HSA_RESPIRATION_DATA_MESG_FIELDS
} FIT_HSA_RESPIRATION_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_RESPIRATION_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_RESPIRATION_DATA_MESG_DEF;

// hsa_heart_rate_data message
#define FIT_HSA_HEART_RATE_DATA_MESG_SIZE                                       8
#define FIT_HSA_HEART_RATE_DATA_MESG_DEF_SIZE                                   17
#define FIT_HSA_HEART_RATE_DATA_MESG_HEART_RATE_COUNT                           1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds
   FIT_UINT8 status; // Status of measurements in buffer - 0 indicates SEARCHING 1 indicates LOCKED
   FIT_UINT8 heart_rate[FIT_HSA_HEART_RATE_DATA_MESG_HEART_RATE_COUNT]; // 1 * bpm + 0, Beats / min. Blank: 0
} FIT_HSA_HEART_RATE_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_HEART_RATE_DATA_FIELD_NUM;

#define FIT_HSA_HEART_RATE_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_HEART_RATE_DATA_FIELD_NUM, 253))
#define FIT_HSA_HEART_RATE_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_HEART_RATE_DATA_FIELD_NUM, 0))
#define FIT_HSA_HEART_RATE_DATA_FIELD_NUM_STATUS (FIT_CAST(FIT_HSA_HEART_RATE_DATA_FIELD_NUM, 1))
#define FIT_HSA_HEART_RATE_DATA_FIELD_NUM_HEART_RATE (FIT_CAST(FIT_HSA_HEART_RATE_DATA_FIELD_NUM, 2))

typedef enum
{
   FIT_HSA_HEART_RATE_DATA_MESG_TIMESTAMP,
   FIT_HSA_HEART_RATE_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_HEART_RATE_DATA_MESG_STATUS,
   FIT_HSA_HEART_RATE_DATA_MESG_HEART_RATE,
   FIT_HSA_HEART_RATE_DATA_MESG_FIELDS
} FIT_HSA_HEART_RATE_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_HEART_RATE_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_HEART_RATE_DATA_MESG_DEF;

// hsa_configuration_data message
#define FIT_HSA_CONFIGURATION_DATA_MESG_SIZE                                    6
#define FIT_HSA_CONFIGURATION_DATA_MESG_DEF_SIZE                                14
#define FIT_HSA_CONFIGURATION_DATA_MESG_DATA_COUNT                              1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0, Encoded configuration data
   FIT_BYTE data[FIT_HSA_CONFIGURATION_DATA_MESG_DATA_COUNT]; // Encoded configuration data. Health SDK use only
   FIT_UINT8 data_size; // Size in bytes of data field
} FIT_HSA_CONFIGURATION_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_CONFIGURATION_DATA_FIELD_NUM;

#define FIT_HSA_CONFIGURATION_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_CONFIGURATION_DATA_FIELD_NUM, 253))
#define FIT_HSA_CONFIGURATION_DATA_FIELD_NUM_DATA (FIT_CAST(FIT_HSA_CONFIGURATION_DATA_FIELD_NUM, 0))
#define FIT_HSA_CONFIGURATION_DATA_FIELD_NUM_DATA_SIZE (FIT_CAST(FIT_HSA_CONFIGURATION_DATA_FIELD_NUM, 1))

typedef enum
{
   FIT_HSA_CONFIGURATION_DATA_MESG_TIMESTAMP,
   FIT_HSA_CONFIGURATION_DATA_MESG_DATA,
   FIT_HSA_CONFIGURATION_DATA_MESG_DATA_SIZE,
   FIT_HSA_CONFIGURATION_DATA_MESG_FIELDS
} FIT_HSA_CONFIGURATION_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_CONFIGURATION_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_CONFIGURATION_DATA_MESG_DEF;

// hsa_wrist_temperature_data message
#define FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_SIZE                                8
#define FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_DEF_SIZE                            14
#define FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_VALUE_COUNT                         1

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_UINT16 processing_interval; // 1 * s + 0, Processing interval length in seconds
   FIT_UINT16 value[FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_VALUE_COUNT]; // 1000 * degC + 0, Wrist temperature reading
} FIT_HSA_WRIST_TEMPERATURE_DATA_MESG;

typedef FIT_UINT8 FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM;

#define FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM, 253))
#define FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM_PROCESSING_INTERVAL (FIT_CAST(FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM, 0))
#define FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM_VALUE (FIT_CAST(FIT_HSA_WRIST_TEMPERATURE_DATA_FIELD_NUM, 1))

typedef enum
{
   FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_TIMESTAMP,
   FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_PROCESSING_INTERVAL,
   FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_VALUE,
   FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_FIELDS
} FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HSA_WRIST_TEMPERATURE_DATA_MESG_DEF;
...
#define FIT_MEMO_GLOB_FIELD_NUM_PART_INDEX (FIT_CAST(FIT_MEMO_GLOB_FIELD_NUM, 250))
#define FIT_MEMO_GLOB_FIELD_NUM_MESG_NUM (FIT_CAST(FIT_MEMO_GLOB_FIELD_NUM, 1))
#define FIT_MEMO_GLOB_FIELD_NUM_PARENT_INDEX (FIT_CAST(FIT_MEMO_GLOB_FIELD_NUM, 2))
#define FIT_MEMO_GLOB_FIELD_NUM_MEMO (FIT_CAST(FIT_MEMO_GLOB_FIELD_NUM, 0))
#define FIT_MEMO_GLOB_FIELD_NUM_FIELD_NUM (FIT_CAST(FIT_MEMO_GLOB_FIELD_NUM, 3))
#define FIT_MEMO_GLOB_FIELD_NUM_DATA (FIT_CAST(FIT_MEMO_GLOB_FIELD_NUM, 4))
...
// sleep_level message
#define FIT_SLEEP_LEVEL_MESG_SIZE                                               5
#define FIT_SLEEP_LEVEL_MESG_DEF_SIZE                                           11

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_SLEEP_LEVEL sleep_level; //
} FIT_SLEEP_LEVEL_MESG;

typedef FIT_UINT8 FIT_SLEEP_LEVEL_FIELD_NUM;

#define FIT_SLEEP_LEVEL_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_SLEEP_LEVEL_FIELD_NUM, 253))
#define FIT_SLEEP_LEVEL_FIELD_NUM_SLEEP_LEVEL (FIT_CAST(FIT_SLEEP_LEVEL_FIELD_NUM, 0))

typedef enum
{
   FIT_SLEEP_LEVEL_MESG_TIMESTAMP,
   FIT_SLEEP_LEVEL_MESG_SLEEP_LEVEL,
   FIT_SLEEP_LEVEL_MESG_FIELDS
} FIT_SLEEP_LEVEL_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SLEEP_LEVEL_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SLEEP_LEVEL_MESG_DEF;
...
#define FIT_ANT_CHANNEL_ID_FIELD_NUM_DEVICE_NUMBER (FIT_CAST(FIT_ANT_CHANNEL_ID_FIELD_NUM, 2))
#define FIT_ANT_CHANNEL_ID_FIELD_NUM_CHANNEL_NUMBER (FIT_CAST(FIT_ANT_CHANNEL_ID_FIELD_NUM, 0))
#define FIT_ANT_CHANNEL_ID_FIELD_NUM_DEVICE_TYPE (FIT_CAST(FIT_ANT_CHANNEL_ID_FIELD_NUM, 1))
#define FIT_ANT_CHANNEL_ID_FIELD_NUM_TRANSMISSION_TYPE (FIT_CAST(FIT_ANT_CHANNEL_ID_FIELD_NUM, 3))
#define FIT_ANT_CHANNEL_ID_FIELD_NUM_DEVICE_INDEX (FIT_CAST(FIT_ANT_CHANNEL_ID_FIELD_NUM, 4))
...
// ant_rx message
#define FIT_ANT_RX_MESG_SIZE                                                    10
#define FIT_ANT_RX_MESG_DEF_SIZE                                                23
#define FIT_ANT_RX_MESG_MESG_DATA_COUNT                                         1
#define FIT_ANT_RX_MESG_DATA_COUNT                                              1
...
// ant_tx message
#define FIT_ANT_TX_MESG_SIZE                                                    10
#define FIT_ANT_TX_MESG_DEF_SIZE                                                23
#define FIT_ANT_TX_MESG_MESG_DATA_COUNT                                         1
#define FIT_ANT_TX_MESG_DATA_COUNT                                              1
...
#define FIT_DIVE_SUMMARY_MESG_SIZE                                              70
#define FIT_DIVE_SUMMARY_MESG_DEF_SIZE                                          74
...
typedef struct
{
   ...
   FIT_UINT32 descent_time; // 1000 * s + 0, Time to reach deepest level stop
   FIT_UINT32 ascent_time; // 1000 * s + 0, Time after leaving bottom until reaching surface
   ...
   FIT_UINT16 end_n2; // 1 * percent + 0,
   FIT_UINT16 o2_toxicity; // 1 * OTUs + 0,
   FIT_UINT16 avg_pressure_sac; // 100 * bar/min + 0, Average pressure-based surface air consumption
   FIT_UINT16 avg_volume_sac; // 100 * L/min + 0, Average volumetric surface air consumption
   FIT_UINT16 avg_rmv; // 100 * L/min + 0, Average respiratory minute volume
   FIT_UINT8 start_cns; // 1 * percent + 0,
   FIT_UINT8 end_cns; // 1 * percent + 0,
...
#define FIT_DIVE_SUMMARY_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 253))
#define FIT_DIVE_SUMMARY_FIELD_NUM_AVG_DEPTH (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 2))
#define FIT_DIVE_SUMMARY_FIELD_NUM_MAX_DEPTH (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 3))
#define FIT_DIVE_SUMMARY_FIELD_NUM_SURFACE_INTERVAL (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 4))
#define FIT_DIVE_SUMMARY_FIELD_NUM_DIVE_NUMBER (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 10))
#define FIT_DIVE_SUMMARY_FIELD_NUM_BOTTOM_TIME (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 11))
#define FIT_DIVE_SUMMARY_FIELD_NUM_DESCENT_TIME (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 15))
#define FIT_DIVE_SUMMARY_FIELD_NUM_ASCENT_TIME (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 16))
#define FIT_DIVE_SUMMARY_FIELD_NUM_AVG_ASCENT_RATE (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 17))
#define FIT_DIVE_SUMMARY_FIELD_NUM_AVG_DESCENT_RATE (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 22))
#define FIT_DIVE_SUMMARY_FIELD_NUM_MAX_ASCENT_RATE (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 23))
#define FIT_DIVE_SUMMARY_FIELD_NUM_MAX_DESCENT_RATE (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 24))
#define FIT_DIVE_SUMMARY_FIELD_NUM_HANG_TIME (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 25))
#define FIT_DIVE_SUMMARY_FIELD_NUM_REFERENCE_MESG (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 0))
#define FIT_DIVE_SUMMARY_FIELD_NUM_REFERENCE_INDEX (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 1))
#define FIT_DIVE_SUMMARY_FIELD_NUM_START_N2 (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 7))
#define FIT_DIVE_SUMMARY_FIELD_NUM_END_N2 (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 8))
#define FIT_DIVE_SUMMARY_FIELD_NUM_O2_TOXICITY (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 9))
#define FIT_DIVE_SUMMARY_FIELD_NUM_AVG_PRESSURE_SAC (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 12))
#define FIT_DIVE_SUMMARY_FIELD_NUM_AVG_VOLUME_SAC (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 13))
#define FIT_DIVE_SUMMARY_FIELD_NUM_AVG_RMV (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 14))
#define FIT_DIVE_SUMMARY_FIELD_NUM_START_CNS (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 5))
#define FIT_DIVE_SUMMARY_FIELD_NUM_END_CNS (FIT_CAST(FIT_DIVE_SUMMARY_FIELD_NUM, 6))
...
typedef enum
{
   ...
   FIT_DIVE_SUMMARY_MESG_DESCENT_TIME,
   FIT_DIVE_SUMMARY_MESG_ASCENT_TIME,
   ...
   FIT_DIVE_SUMMARY_MESG_AVG_PRESSURE_SAC,
   FIT_DIVE_SUMMARY_MESG_AVG_VOLUME_SAC,
   FIT_DIVE_SUMMARY_MESG_AVG_RMV,
...
// aad_accel_features message
#define FIT_AAD_ACCEL_FEATURES_MESG_SIZE                                        15
#define FIT_AAD_ACCEL_FEATURES_MESG_DEF_SIZE                                    23

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT32 energy_total; // Total accelerometer energy in the interval
   FIT_UINT16 time; // 1 * s + 0, Time interval length in seconds
   FIT_UINT16 zero_cross_cnt; // Count of zero crossings
   FIT_UINT16 time_above_threshold; // 25 * s + 0, Total accelerometer time above threshold in the interval
   FIT_UINT8 instance; // Instance ID of zero crossing algorithm
} FIT_AAD_ACCEL_FEATURES_MESG;

typedef FIT_UINT8 FIT_AAD_ACCEL_FEATURES_FIELD_NUM;

#define FIT_AAD_ACCEL_FEATURES_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_AAD_ACCEL_FEATURES_FIELD_NUM, 253))
#define FIT_AAD_ACCEL_FEATURES_FIELD_NUM_ENERGY_TOTAL (FIT_CAST(FIT_AAD_ACCEL_FEATURES_FIELD_NUM, 1))
#define FIT_AAD_ACCEL_FEATURES_FIELD_NUM_TIME (FIT_CAST(FIT_AAD_ACCEL_FEATURES_FIELD_NUM, 0))
#define FIT_AAD_ACCEL_FEATURES_FIELD_NUM_ZERO_CROSS_CNT (FIT_CAST(FIT_AAD_ACCEL_FEATURES_FIELD_NUM, 2))
#define FIT_AAD_ACCEL_FEATURES_FIELD_NUM_TIME_ABOVE_THRESHOLD (FIT_CAST(FIT_AAD_ACCEL_FEATURES_FIELD_NUM, 4))
#define FIT_AAD_ACCEL_FEATURES_FIELD_NUM_INSTANCE (FIT_CAST(FIT_AAD_ACCEL_FEATURES_FIELD_NUM, 3))

typedef enum
{
   FIT_AAD_ACCEL_FEATURES_MESG_TIMESTAMP,
   FIT_AAD_ACCEL_FEATURES_MESG_ENERGY_TOTAL,
   FIT_AAD_ACCEL_FEATURES_MESG_TIME,
   FIT_AAD_ACCEL_FEATURES_MESG_ZERO_CROSS_CNT,
   FIT_AAD_ACCEL_FEATURES_MESG_TIME_ABOVE_THRESHOLD,
   FIT_AAD_ACCEL_FEATURES_MESG_INSTANCE,
   FIT_AAD_ACCEL_FEATURES_MESG_FIELDS
} FIT_AAD_ACCEL_FEATURES_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_AAD_ACCEL_FEATURES_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_AAD_ACCEL_FEATURES_MESG_DEF;
...
// beat_intervals message
#define FIT_BEAT_INTERVALS_MESG_SIZE                                            8
#define FIT_BEAT_INTERVALS_MESG_DEF_SIZE                                        14
#define FIT_BEAT_INTERVALS_MESG_TIME_COUNT                                      1

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Milliseconds past date_time
   FIT_UINT16 time[FIT_BEAT_INTERVALS_MESG_TIME_COUNT]; // 1 * ms + 0, Array of millisecond times between beats
} FIT_BEAT_INTERVALS_MESG;

typedef FIT_UINT8 FIT_BEAT_INTERVALS_FIELD_NUM;

#define FIT_BEAT_INTERVALS_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_BEAT_INTERVALS_FIELD_NUM, 253))
#define FIT_BEAT_INTERVALS_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_BEAT_INTERVALS_FIELD_NUM, 0))
#define FIT_BEAT_INTERVALS_FIELD_NUM_TIME (FIT_CAST(FIT_BEAT_INTERVALS_FIELD_NUM, 1))

typedef enum
{
   FIT_BEAT_INTERVALS_MESG_TIMESTAMP,
   FIT_BEAT_INTERVALS_MESG_TIMESTAMP_MS,
   FIT_BEAT_INTERVALS_MESG_TIME,
   FIT_BEAT_INTERVALS_MESG_FIELDS
} FIT_BEAT_INTERVALS_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_BEAT_INTERVALS_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_BEAT_INTERVALS_MESG_DEF;

// hrv_status_summary message
#define FIT_HRV_STATUS_SUMMARY_MESG_SIZE                                        17
#define FIT_HRV_STATUS_SUMMARY_MESG_DEF_SIZE                                    29

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT16 weekly_average; // 128 * ms + 0, 7 day RMSSD average over sleep
   FIT_UINT16 last_night_average; // 128 * ms + 0, Last night RMSSD average over sleep
   FIT_UINT16 last_night_5_min_high; // 128 * ms + 0, 5 minute high RMSSD value over sleep
   FIT_UINT16 baseline_low_upper; // 128 * ms + 0, 3 week baseline, upper boundary of low HRV status
   FIT_UINT16 baseline_balanced_lower; // 128 * ms + 0, 3 week baseline, lower boundary of balanced HRV status
   FIT_UINT16 baseline_balanced_upper; // 128 * ms + 0, 3 week baseline, upper boundary of balanced HRV status
   FIT_HRV_STATUS status; //
} FIT_HRV_STATUS_SUMMARY_MESG;

typedef FIT_UINT8 FIT_HRV_STATUS_SUMMARY_FIELD_NUM;

#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 253))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_WEEKLY_AVERAGE (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 0))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_LAST_NIGHT_AVERAGE (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 1))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_LAST_NIGHT_5_MIN_HIGH (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 2))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_BASELINE_LOW_UPPER (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 3))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_BASELINE_BALANCED_LOWER (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 4))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_BASELINE_BALANCED_UPPER (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 5))
#define FIT_HRV_STATUS_SUMMARY_FIELD_NUM_STATUS (FIT_CAST(FIT_HRV_STATUS_SUMMARY_FIELD_NUM, 6))

typedef enum
{
   FIT_HRV_STATUS_SUMMARY_MESG_TIMESTAMP,
   FIT_HRV_STATUS_SUMMARY_MESG_WEEKLY_AVERAGE,
   FIT_HRV_STATUS_SUMMARY_MESG_LAST_NIGHT_AVERAGE,
   FIT_HRV_STATUS_SUMMARY_MESG_LAST_NIGHT_5_MIN_HIGH,
   FIT_HRV_STATUS_SUMMARY_MESG_BASELINE_LOW_UPPER,
   FIT_HRV_STATUS_SUMMARY_MESG_BASELINE_BALANCED_LOWER,
   FIT_HRV_STATUS_SUMMARY_MESG_BASELINE_BALANCED_UPPER,
   FIT_HRV_STATUS_SUMMARY_MESG_STATUS,
   FIT_HRV_STATUS_SUMMARY_MESG_FIELDS
} FIT_HRV_STATUS_SUMMARY_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HRV_STATUS_SUMMARY_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HRV_STATUS_SUMMARY_MESG_DEF;

// hrv_value message
#define FIT_HRV_VALUE_MESG_SIZE                                                 6
#define FIT_HRV_VALUE_MESG_DEF_SIZE                                             11

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT16 value; // 128 * ms + 0, 5 minute RMSSD
} FIT_HRV_VALUE_MESG;

typedef FIT_UINT8 FIT_HRV_VALUE_FIELD_NUM;

#define FIT_HRV_VALUE_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_HRV_VALUE_FIELD_NUM, 253))
#define FIT_HRV_VALUE_FIELD_NUM_VALUE (FIT_CAST(FIT_HRV_VALUE_FIELD_NUM, 0))

typedef enum
{
   FIT_HRV_VALUE_MESG_TIMESTAMP,
   FIT_HRV_VALUE_MESG_VALUE,
   FIT_HRV_VALUE_MESG_FIELDS
} FIT_HRV_VALUE_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_HRV_VALUE_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_HRV_VALUE_MESG_DEF;

// raw_bbi message
#define FIT_RAW_BBI_MESG_SIZE                                                   12
#define FIT_RAW_BBI_MESG_DEF_SIZE                                               23
#define FIT_RAW_BBI_MESG_DATA_COUNT                                             1
#define FIT_RAW_BBI_MESG_TIME_COUNT                                             1
#define FIT_RAW_BBI_MESG_QUALITY_COUNT                                          1
#define FIT_RAW_BBI_MESG_GAP_COUNT                                              1

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT16 timestamp_ms; // 1 * ms + 0, Millisecond resolution of the timestamp
   FIT_UINT16 data[FIT_RAW_BBI_MESG_DATA_COUNT]; // 1 bit for gap indicator, 1 bit for quality indicator, and 14 bits for Beat-to-Beat interval values in whole-integer millisecond resolution
   FIT_UINT16 time[FIT_RAW_BBI_MESG_TIME_COUNT]; // 1 * ms + 0, Array of millisecond times between beats
   FIT_UINT8 quality[FIT_RAW_BBI_MESG_QUALITY_COUNT]; // 1 = high confidence. 0 = low confidence. N/A when gap = 1
   FIT_UINT8 gap[FIT_RAW_BBI_MESG_GAP_COUNT]; // 1 = gap (time represents ms gap length). 0 = BBI data
} FIT_RAW_BBI_MESG;

typedef FIT_UINT8 FIT_RAW_BBI_FIELD_NUM;

#define FIT_RAW_BBI_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_RAW_BBI_FIELD_NUM, 253))
#define FIT_RAW_BBI_FIELD_NUM_TIMESTAMP_MS (FIT_CAST(FIT_RAW_BBI_FIELD_NUM, 0))
#define FIT_RAW_BBI_FIELD_NUM_DATA (FIT_CAST(FIT_RAW_BBI_FIELD_NUM, 1))
#define FIT_RAW_BBI_FIELD_NUM_TIME (FIT_CAST(FIT_RAW_BBI_FIELD_NUM, 2))
#define FIT_RAW_BBI_FIELD_NUM_QUALITY (FIT_CAST(FIT_RAW_BBI_FIELD_NUM, 3))
#define FIT_RAW_BBI_FIELD_NUM_GAP (FIT_CAST(FIT_RAW_BBI_FIELD_NUM, 4))

typedef enum
{
   FIT_RAW_BBI_MESG_TIMESTAMP,
   FIT_RAW_BBI_MESG_TIMESTAMP_MS,
   FIT_RAW_BBI_MESG_DATA,
   FIT_RAW_BBI_MESG_TIME,
   FIT_RAW_BBI_MESG_QUALITY,
   FIT_RAW_BBI_MESG_GAP,
   FIT_RAW_BBI_MESG_FIELDS
} FIT_RAW_BBI_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_RAW_BBI_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_RAW_BBI_MESG_DEF;

// respiration_rate message
#define FIT_RESPIRATION_RATE_MESG_SIZE                                          6
#define FIT_RESPIRATION_RATE_MESG_DEF_SIZE                                      11

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_SINT16 respiration_rate; // 100 * breaths/min + 0, Breaths * 100 /min, -300 indicates invalid, -200 indicates large motion, -100 indicates off wrist
} FIT_RESPIRATION_RATE_MESG;

typedef FIT_UINT8 FIT_RESPIRATION_RATE_FIELD_NUM;

#define FIT_RESPIRATION_RATE_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_RESPIRATION_RATE_FIELD_NUM, 253))
#define FIT_RESPIRATION_RATE_FIELD_NUM_RESPIRATION_RATE (FIT_CAST(FIT_RESPIRATION_RATE_FIELD_NUM, 0))

typedef enum
{
   FIT_RESPIRATION_RATE_MESG_TIMESTAMP,
   FIT_RESPIRATION_RATE_MESG_RESPIRATION_RATE,
   FIT_RESPIRATION_RATE_MESG_FIELDS
} FIT_RESPIRATION_RATE_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_RESPIRATION_RATE_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_RESPIRATION_RATE_MESG_DEF;

// chrono_shot_session message
#define FIT_CHRONO_SHOT_SESSION_MESG_SIZE                                       27
#define FIT_CHRONO_SHOT_SESSION_MESG_DEF_SIZE                                   29

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT32 min_speed; // 1000 * m/s + 0,
   FIT_UINT32 max_speed; // 1000 * m/s + 0,
   FIT_UINT32 avg_speed; // 1000 * m/s + 0,
   FIT_UINT32 grain_weight; // 10 * gr + 0,
   FIT_UINT32 standard_deviation; // 1000 * m/s + 0,
   FIT_UINT16 shot_count; //
   FIT_PROJECTILE_TYPE projectile_type; //
} FIT_CHRONO_SHOT_SESSION_MESG;

typedef FIT_UINT8 FIT_CHRONO_SHOT_SESSION_FIELD_NUM;

#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 253))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_MIN_SPEED (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 0))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_MAX_SPEED (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 1))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_AVG_SPEED (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 2))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_GRAIN_WEIGHT (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 5))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_STANDARD_DEVIATION (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 6))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_SHOT_COUNT (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 3))
#define FIT_CHRONO_SHOT_SESSION_FIELD_NUM_PROJECTILE_TYPE (FIT_CAST(FIT_CHRONO_SHOT_SESSION_FIELD_NUM, 4))

typedef enum
{
   FIT_CHRONO_SHOT_SESSION_MESG_TIMESTAMP,
   FIT_CHRONO_SHOT_SESSION_MESG_MIN_SPEED,
   FIT_CHRONO_SHOT_SESSION_MESG_MAX_SPEED,
   FIT_CHRONO_SHOT_SESSION_MESG_AVG_SPEED,
   FIT_CHRONO_SHOT_SESSION_MESG_GRAIN_WEIGHT,
   FIT_CHRONO_SHOT_SESSION_MESG_STANDARD_DEVIATION,
   FIT_CHRONO_SHOT_SESSION_MESG_SHOT_COUNT,
   FIT_CHRONO_SHOT_SESSION_MESG_PROJECTILE_TYPE,
   FIT_CHRONO_SHOT_SESSION_MESG_FIELDS
} FIT_CHRONO_SHOT_SESSION_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_CHRONO_SHOT_SESSION_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_CHRONO_SHOT_SESSION_MESG_DEF;

// chrono_shot_data message
#define FIT_CHRONO_SHOT_DATA_MESG_SIZE                                          10
#define FIT_CHRONO_SHOT_DATA_MESG_DEF_SIZE                                      14

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_UINT32 shot_speed; // 1000 * m/s + 0,
   FIT_UINT16 shot_num; //
} FIT_CHRONO_SHOT_DATA_MESG;

typedef FIT_UINT8 FIT_CHRONO_SHOT_DATA_FIELD_NUM;

#define FIT_CHRONO_SHOT_DATA_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_CHRONO_SHOT_DATA_FIELD_NUM, 253))
#define FIT_CHRONO_SHOT_DATA_FIELD_NUM_SHOT_SPEED (FIT_CAST(FIT_CHRONO_SHOT_DATA_FIELD_NUM, 0))
#define FIT_CHRONO_SHOT_DATA_FIELD_NUM_SHOT_NUM (FIT_CAST(FIT_CHRONO_SHOT_DATA_FIELD_NUM, 1))

typedef enum
{
   FIT_CHRONO_SHOT_DATA_MESG_TIMESTAMP,
   FIT_CHRONO_SHOT_DATA_MESG_SHOT_SPEED,
   FIT_CHRONO_SHOT_DATA_MESG_SHOT_NUM,
   FIT_CHRONO_SHOT_DATA_MESG_FIELDS
} FIT_CHRONO_SHOT_DATA_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_CHRONO_SHOT_DATA_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_CHRONO_SHOT_DATA_MESG_DEF;

// tank_update message
#define FIT_TANK_UPDATE_MESG_SIZE                                               10
#define FIT_TANK_UPDATE_MESG_DEF_SIZE                                           14

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_ANT_CHANNEL_ID sensor; //
   FIT_UINT16 pressure; // 100 * bar + 0,
} FIT_TANK_UPDATE_MESG;

typedef FIT_UINT8 FIT_TANK_UPDATE_FIELD_NUM;

#define FIT_TANK_UPDATE_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_TANK_UPDATE_FIELD_NUM, 253))
#define FIT_TANK_UPDATE_FIELD_NUM_SENSOR (FIT_CAST(FIT_TANK_UPDATE_FIELD_NUM, 0))
#define FIT_TANK_UPDATE_FIELD_NUM_PRESSURE (FIT_CAST(FIT_TANK_UPDATE_FIELD_NUM, 1))

typedef enum
{
   FIT_TANK_UPDATE_MESG_TIMESTAMP,
   FIT_TANK_UPDATE_MESG_SENSOR,
   FIT_TANK_UPDATE_MESG_PRESSURE,
   FIT_TANK_UPDATE_MESG_FIELDS
} FIT_TANK_UPDATE_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_TANK_UPDATE_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_TANK_UPDATE_MESG_DEF;

// tank_summary message
#define FIT_TANK_SUMMARY_MESG_SIZE                                              16
#define FIT_TANK_SUMMARY_MESG_DEF_SIZE                                          20

typedef struct
{
   FIT_DATE_TIME timestamp; // 1 * s + 0,
   FIT_ANT_CHANNEL_ID sensor; //
   FIT_UINT32 volume_used; // 100 * L + 0,
   FIT_UINT16 start_pressure; // 100 * bar + 0,
   FIT_UINT16 end_pressure; // 100 * bar + 0,
} FIT_TANK_SUMMARY_MESG;

typedef FIT_UINT8 FIT_TANK_SUMMARY_FIELD_NUM;

#define FIT_TANK_SUMMARY_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_TANK_SUMMARY_FIELD_NUM, 253))
#define FIT_TANK_SUMMARY_FIELD_NUM_SENSOR (FIT_CAST(FIT_TANK_SUMMARY_FIELD_NUM, 0))
#define FIT_TANK_SUMMARY_FIELD_NUM_VOLUME_USED (FIT_CAST(FIT_TANK_SUMMARY_FIELD_NUM, 3))
#define FIT_TANK_SUMMARY_FIELD_NUM_START_PRESSURE (FIT_CAST(FIT_TANK_SUMMARY_FIELD_NUM, 1))
#define FIT_TANK_SUMMARY_FIELD_NUM_END_PRESSURE (FIT_CAST(FIT_TANK_SUMMARY_FIELD_NUM, 2))

typedef enum
{
   FIT_TANK_SUMMARY_MESG_TIMESTAMP,
   FIT_TANK_SUMMARY_MESG_SENSOR,
   FIT_TANK_SUMMARY_MESG_VOLUME_USED,
   FIT_TANK_SUMMARY_MESG_START_PRESSURE,
   FIT_TANK_SUMMARY_MESG_END_PRESSURE,
   FIT_TANK_SUMMARY_MESG_FIELDS
} FIT_TANK_SUMMARY_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_TANK_SUMMARY_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_TANK_SUMMARY_MESG_DEF;

// sleep_assessment message
#define FIT_SLEEP_ASSESSMENT_MESG_SIZE                                          15
#define FIT_SLEEP_ASSESSMENT_MESG_DEF_SIZE                                      47

typedef struct
{
   FIT_UINT16 average_stress_during_sleep; // Excludes stress during awake periods in the sleep window
   FIT_UINT8 combined_awake_score; // Average of awake_time_score and awakenings_count_score. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 awake_time_score; // Score that evaluates the total time spent awake between sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 awakenings_count_score; // Score that evaluates the number of awakenings that interrupt sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 deep_sleep_score; // Score that evaluates the amount of deep sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 sleep_duration_score; // Score that evaluates the quality of sleep based on sleep stages, heart-rate variability and possible awakenings during the night. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 light_sleep_score; // Score that evaluates the amount of light sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 overall_sleep_score; // Total score that summarizes the overall quality of sleep, combining sleep duration and quality. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 sleep_quality_score; // Score that evaluates the quality of sleep based on sleep stages, heart-rate variability and possible awakenings during the night. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 sleep_recovery_score; // Score that evaluates stress and recovery during sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 rem_sleep_score; // Score that evaluates the amount of REM sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 sleep_restlessness_score; // Score that evaluates the amount of restlessness during sleep. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
   FIT_UINT8 awakenings_count; // The number of awakenings during sleep.
   FIT_UINT8 interruptions_score; // Score that evaluates the sleep interruptions. If valid: 0 (worst) to 100 (best). If unknown: FIT_UINT8_INVALID.
} FIT_SLEEP_ASSESSMENT_MESG;

typedef FIT_UINT8 FIT_SLEEP_ASSESSMENT_FIELD_NUM;

#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_AVERAGE_STRESS_DURING_SLEEP (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 15))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_COMBINED_AWAKE_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 0))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_AWAKE_TIME_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 1))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_AWAKENINGS_COUNT_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 2))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_DEEP_SLEEP_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 3))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_SLEEP_DURATION_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 4))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_LIGHT_SLEEP_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 5))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_OVERALL_SLEEP_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 6))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_SLEEP_QUALITY_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 7))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_SLEEP_RECOVERY_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 8))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_REM_SLEEP_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 9))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_SLEEP_RESTLESSNESS_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 10))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_AWAKENINGS_COUNT (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 11))
#define FIT_SLEEP_ASSESSMENT_FIELD_NUM_INTERRUPTIONS_SCORE (FIT_CAST(FIT_SLEEP_ASSESSMENT_FIELD_NUM, 14))

typedef enum
{
   FIT_SLEEP_ASSESSMENT_MESG_AVERAGE_STRESS_DURING_SLEEP,
   FIT_SLEEP_ASSESSMENT_MESG_COMBINED_AWAKE_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_AWAKE_TIME_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_AWAKENINGS_COUNT_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_DEEP_SLEEP_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_SLEEP_DURATION_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_LIGHT_SLEEP_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_OVERALL_SLEEP_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_SLEEP_QUALITY_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_SLEEP_RECOVERY_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_REM_SLEEP_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_SLEEP_RESTLESSNESS_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_AWAKENINGS_COUNT,
   FIT_SLEEP_ASSESSMENT_MESG_INTERRUPTIONS_SCORE,
   FIT_SLEEP_ASSESSMENT_MESG_FIELDS
} FIT_SLEEP_ASSESSMENT_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SLEEP_ASSESSMENT_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SLEEP_ASSESSMENT_MESG_DEF;

// sleep_disruption_severity_period message
#define FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_SIZE                          7
#define FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_DEF_SIZE                      14

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_MESSAGE_INDEX message_index; //
   FIT_SLEEP_DISRUPTION_SEVERITY severity; //
} FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG;

typedef FIT_UINT8 FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM;

#define FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM, 253))
#define FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM, 254))
#define FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM_SEVERITY (FIT_CAST(FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_FIELD_NUM, 0))

typedef enum
{
   FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_TIMESTAMP,
   FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_MESSAGE_INDEX,
   FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_SEVERITY,
   FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_FIELDS
} FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SLEEP_DISRUPTION_SEVERITY_PERIOD_MESG_DEF;

// sleep_disruption_overnight_severity message
#define FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_SIZE                       5
#define FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_DEF_SIZE                   11

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_SLEEP_DISRUPTION_SEVERITY severity; //
} FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG;

typedef FIT_UINT8 FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_FIELD_NUM;

#define FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_FIELD_NUM, 253))
#define FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_FIELD_NUM_SEVERITY (FIT_CAST(FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_FIELD_NUM, 0))

typedef enum
{
   FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_TIMESTAMP,
   FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_SEVERITY,
   FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_FIELDS
} FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY_MESG_DEF;

// nap_event message
#define FIT_NAP_EVENT_MESG_SIZE                                                 25
#define FIT_NAP_EVENT_MESG_DEF_SIZE                                             35

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_DATE_TIME start_time; // 1 * seconds + 0,
   FIT_DATE_TIME end_time; // 1 * seconds + 0,
   FIT_DATE_TIME update_timestamp; // The timestamp representing when this nap event was last updated
   FIT_MESSAGE_INDEX message_index; //
   FIT_SINT16 start_timezone_offset; // 1 * minutes + 0,
   FIT_SINT16 end_timezone_offset; // 1 * minutes + 0,
   FIT_NAP_PERIOD_FEEDBACK feedback; //
   FIT_BOOL is_deleted; //
   FIT_NAP_SOURCE source; //
} FIT_NAP_EVENT_MESG;

typedef FIT_UINT8 FIT_NAP_EVENT_FIELD_NUM;

#define FIT_NAP_EVENT_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 253))
#define FIT_NAP_EVENT_FIELD_NUM_START_TIME (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 0))
#define FIT_NAP_EVENT_FIELD_NUM_END_TIME (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 2))
#define FIT_NAP_EVENT_FIELD_NUM_UPDATE_TIMESTAMP (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 7))
#define FIT_NAP_EVENT_FIELD_NUM_MESSAGE_INDEX (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 254))
#define FIT_NAP_EVENT_FIELD_NUM_START_TIMEZONE_OFFSET (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 1))
#define FIT_NAP_EVENT_FIELD_NUM_END_TIMEZONE_OFFSET (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 3))
#define FIT_NAP_EVENT_FIELD_NUM_FEEDBACK (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 4))
#define FIT_NAP_EVENT_FIELD_NUM_IS_DELETED (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 5))
#define FIT_NAP_EVENT_FIELD_NUM_SOURCE (FIT_CAST(FIT_NAP_EVENT_FIELD_NUM, 6))

typedef enum
{
   FIT_NAP_EVENT_MESG_TIMESTAMP,
   FIT_NAP_EVENT_MESG_START_TIME,
   FIT_NAP_EVENT_MESG_END_TIME,
   FIT_NAP_EVENT_MESG_UPDATE_TIMESTAMP,
   FIT_NAP_EVENT_MESG_MESSAGE_INDEX,
   FIT_NAP_EVENT_MESG_START_TIMEZONE_OFFSET,
   FIT_NAP_EVENT_MESG_END_TIMEZONE_OFFSET,
   FIT_NAP_EVENT_MESG_FEEDBACK,
   FIT_NAP_EVENT_MESG_IS_DELETED,
   FIT_NAP_EVENT_MESG_SOURCE,
   FIT_NAP_EVENT_MESG_FIELDS
} FIT_NAP_EVENT_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_NAP_EVENT_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_NAP_EVENT_MESG_DEF;

// skin_temp_overnight message
#define FIT_SKIN_TEMP_OVERNIGHT_MESG_SIZE                                       20
#define FIT_SKIN_TEMP_OVERNIGHT_MESG_DEF_SIZE                                   20

typedef struct
{
   FIT_DATE_TIME timestamp; //
   FIT_LOCAL_DATE_TIME local_timestamp; //
   FIT_FLOAT32 average_deviation; // The average overnight deviation from baseline temperature in degrees C
   FIT_FLOAT32 average_7_day_deviation; // The average 7 day overnight deviation from baseline temperature in degrees C
   FIT_FLOAT32 nightly_value; // Final overnight temperature value
} FIT_SKIN_TEMP_OVERNIGHT_MESG;

typedef FIT_UINT8 FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM;

#define FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM_TIMESTAMP (FIT_CAST(FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM, 253))
#define FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM_LOCAL_TIMESTAMP (FIT_CAST(FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM, 0))
#define FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM_AVERAGE_DEVIATION (FIT_CAST(FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM, 1))
#define FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM_AVERAGE_7_DAY_DEVIATION (FIT_CAST(FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM, 2))
#define FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM_NIGHTLY_VALUE (FIT_CAST(FIT_SKIN_TEMP_OVERNIGHT_FIELD_NUM, 4))

typedef enum
{
   FIT_SKIN_TEMP_OVERNIGHT_MESG_TIMESTAMP,
   FIT_SKIN_TEMP_OVERNIGHT_MESG_LOCAL_TIMESTAMP,
   FIT_SKIN_TEMP_OVERNIGHT_MESG_AVERAGE_DEVIATION,
   FIT_SKIN_TEMP_OVERNIGHT_MESG_AVERAGE_7_DAY_DEVIATION,
   FIT_SKIN_TEMP_OVERNIGHT_MESG_NIGHTLY_VALUE,
   FIT_SKIN_TEMP_OVERNIGHT_MESG_FIELDS
} FIT_SKIN_TEMP_OVERNIGHT_MESG_FIELD;
...
typedef struct
{
   ...
   FIT_MESG_NUM global_mesg_num;
   FIT_UINT8 num_fields;
   FIT_UINT8 fields[FIT_SKIN_TEMP_OVERNIGHT_MESG_FIELDS * FIT_FIELD_DEF_SIZE];
} FIT_SKIN_TEMP_OVERNIGHT_MESG_DEF;
...
typedef enum {
   ...
   FIT_MESG_MAX_MET_DATA,
   FIT_MESG_HSA_BODY_BATTERY_DATA,
   FIT_MESG_HSA_EVENT,
   FIT_MESG_HSA_ACCELEROMETER_DATA,
   FIT_MESG_HSA_GYROSCOPE_DATA,
   FIT_MESG_HSA_STEP_DATA,
   FIT_MESG_HSA_SPO2_DATA,
   FIT_MESG_HSA_STRESS_DATA,
   FIT_MESG_HSA_RESPIRATION_DATA,
   FIT_MESG_HSA_HEART_RATE_DATA,
   FIT_MESG_HSA_CONFIGURATION_DATA,
   FIT_MESG_HSA_WRIST_TEMPERATURE_DATA,
   FIT_MESG_MEMO_GLOB,
   FIT_MESG_SLEEP_LEVEL,
   ...
   FIT_MESG_AAD_ACCEL_FEATURES,
   FIT_MESG_HRV,
   FIT_MESG_BEAT_INTERVALS,
   FIT_MESG_HRV_STATUS_SUMMARY,
   FIT_MESG_HRV_VALUE,
   FIT_MESG_RAW_BBI,
   FIT_MESG_RESPIRATION_RATE,
   FIT_MESG_CHRONO_SHOT_SESSION,
   FIT_MESG_CHRONO_SHOT_DATA,
   FIT_MESG_TANK_UPDATE,
   FIT_MESG_TANK_SUMMARY,
   FIT_MESG_SLEEP_ASSESSMENT,
   FIT_MESG_SLEEP_DISRUPTION_SEVERITY_PERIOD,
   FIT_MESG_SLEEP_DISRUPTION_OVERNIGHT_SEVERITY,
   FIT_MESG_NAP_EVENT,
   FIT_MESG_SKIN_TEMP_OVERNIGHT,
   FIT_MESGS
} FIT_MESG;

typedef const FIT_MESG_DEF * FIT_CONST_MESG_DEF_PTR;
extern const FIT_CONST_MESG_DEF_PTR fit_mesg_defs[FIT_MESGS];
#if defined(FIT_GET_MESG_DEF_BINARY_SEARCH)
extern const FIT_CONST_MESG_DEF_PTR fit_base_mesg_defs[FIT_MESGS];
#endif
...
#define FIT_FILE_DATA_SIZE       (FIT_CAST(FIT_UINT32, 44))
...
#define FIT_DEVICE_FILE_DATA_SIZE                                               (FIT_CAST(FIT_UINT32, 44))
...
#define FIT_DEVICE_FILE_COUNT                                                   0
