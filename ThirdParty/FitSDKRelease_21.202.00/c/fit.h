...
#include "fit_config.h"
   ...
   #define FIT_CAST(_type, _value)   static_cast<_type>(_value)
   #define FIT_REINTERPRET_CAST(_type, _value)  *(reinterpret_cast<_type>(const_cast<unsigned char*>(_value)))
#else
   #define FIT_CAST(_type, _value)   ((_type)(_value))
   #define FIT_REINTERPRET_CAST(_type, _value)  *(FIT_CAST(_type, _value))
#endif
...
#define FIT_PROTOCOL_VERSION_10              ( FIT_CAST( FIT_UINT8, 1 << FIT_PROTOCOL_VERSION_MAJOR_SHIFT ) | 0 )
#define FIT_PROTOCOL_VERSION_20              ( FIT_CAST( FIT_UINT8, 2 << FIT_PROTOCOL_VERSION_MAJOR_SHIFT ) | 0 )

#if !defined(FIT_CPP_INCLUDE_C)
    #define FIT_PROTOCOL_VERSION_MAJOR(version)  ( FIT_CAST( FIT_UINT8, version >> FIT_PROTOCOL_VERSION_MAJOR_SHIFT ) )
    #define FIT_PROTOCOL_VERSION_MINOR(version)  ( FIT_CAST( FIT_UINT8, version & FIT_PROTOCOL_VERSION_MINOR_MASK ) )
    #define FIT_PROTOCOL_VERSION_MAJOR_SHIFT     4
    #define FIT_PROTOCOL_VERSION_MAJOR_MASK      ( FIT_CAST(FIT_UINT8, 0x0F << FIT_PROTOCOL_VERSION_MAJOR_SHIFT) )
    #define FIT_PROTOCOL_VERSION_MINOR_MASK      ( FIT_CAST(FIT_UINT8, 0x0F) )
    ...
    #define FIT_PROFILE_VERSION_MINOR            202
    #define FIT_PROFILE_VERSION_SCALE            1000
    #define FIT_PROFILE_VERSION                  ( FIT_CAST(FIT_UINT16, FIT_PROFILE_VERSION_MAJOR * FIT_PROFILE_VERSION_SCALE + FIT_PROFILE_VERSION_MINOR))
...
#define FIT_BASE_TYPE_ENDIAN_FLAG   (FIT_CAST(FIT_UINT8, 0x80))
#define FIT_BASE_TYPE_RESERVED      (FIT_CAST(FIT_UINT8, 0x60))
#define FIT_BASE_TYPE_NUM_MASK      (FIT_CAST(FIT_UINT8, 0x1F))

typedef uint8_t FIT_ENUM;
typedef const FIT_ENUM * FIT_CONST_ENUM_PTR;
#define FIT_ENUM_INVALID            (FIT_CAST(FIT_ENUM, 0xFF))
#define FIT_BASE_TYPE_ENUM          (FIT_CAST(FIT_UINT8, 0x00))

typedef int8_t FIT_SINT8;
typedef const FIT_SINT8 * FIT_CONST_SINT8_PTR;
#define FIT_SINT8_INVALID           (FIT_CAST(FIT_SINT8, 0x7F))
#define FIT_BASE_TYPE_SINT8         (FIT_CAST(FIT_UINT8, 0x01))

typedef uint8_t FIT_UINT8;
typedef const FIT_UINT8 * FIT_CONST_UINT8_PTR;
#define FIT_UINT8_INVALID           (FIT_CAST(FIT_UINT8, 0xFF))
#define FIT_BASE_TYPE_UINT8         (FIT_CAST(FIT_UINT8, 0x02))

typedef int16_t FIT_SINT16;
typedef const FIT_SINT16 * FIT_CONST_SINT16_PTR;
#define FIT_SINT16_INVALID          (FIT_CAST(FIT_SINT16, 0x7FFF))
#define FIT_BASE_TYPE_SINT16        (FIT_CAST(FIT_UINT8, 0x83))

typedef uint16_t FIT_UINT16;
typedef const FIT_UINT16 * FIT_CONST_UINT16_PTR;
#define FIT_UINT16_INVALID   (FIT_CAST(FIT_UINT16, 0xFFFF))
#define FIT_BASE_TYPE_UINT16 (FIT_CAST(FIT_UINT8, 0x84))

typedef int32_t FIT_SINT32;
typedef const FIT_SINT32 * FIT_CONST_SINT32_PTR;
#define FIT_SINT32_INVALID   (FIT_CAST(FIT_SINT32, 0x7FFFFFFF))
#define FIT_BASE_TYPE_SINT32 (FIT_CAST(FIT_UINT8, 0x85))

typedef uint32_t FIT_UINT32;
typedef const FIT_UINT32 * FIT_CONST_UINT32_PTR;
#define FIT_UINT32_INVALID   (FIT_CAST(FIT_UINT32, 0xFFFFFFFF))
#define FIT_BASE_TYPE_UINT32 (FIT_CAST(FIT_UINT8, 0x86))

typedef char FIT_STRING; // UTF-8 null terminated string
typedef const FIT_STRING * FIT_CONST_STRING_PTR;
#define FIT_STRING_INVALID   (FIT_CAST(FIT_STRING, 0x00))
#define FIT_BASE_TYPE_STRING (FIT_CAST(FIT_UINT8, 0x07))

#if !defined(FIT_CPP_INCLUDE_C)
    typedef float FIT_FLOAT32;
    typedef const FIT_FLOAT32 * FIT_CONST_FLOAT32_PTR;
    #define FIT_FLOAT32_INVALID  FIT_REINTERPRET_CAST(FIT_FLOAT32*, fit_base_type_invalids[FIT_BASE_TYPE_FLOAT32 & FIT_BASE_TYPE_NUM_MASK])
    #define FIT_BASE_TYPE_FLOAT32 (FIT_CAST(FIT_UINT8, 0x88))

    typedef double FIT_FLOAT64;
    typedef const FIT_FLOAT64 * FIT_CONST_FLOAT64_PTR;
    #define FIT_FLOAT64_INVALID   FIT_REINTERPRET_CAST(FIT_FLOAT64*, fit_base_type_invalids[FIT_BASE_TYPE_FLOAT64 & FIT_BASE_TYPE_NUM_MASK])
    #define FIT_BASE_TYPE_FLOAT64 (FIT_CAST(FIT_UINT8, 0x89))
#endif // !defined(FIT_CPP_INCLUDE_C)

typedef uint8_t FIT_UINT8Z;
typedef const FIT_UINT8Z * FIT_CONST_UINT8Z_PTR;
#define FIT_UINT8Z_INVALID   (FIT_CAST(FIT_UINT8Z, 0x00))
#define FIT_BASE_TYPE_UINT8Z (FIT_CAST(FIT_UINT8, 0x0A))

typedef uint16_t FIT_UINT16Z;
typedef const FIT_UINT16Z * FIT_CONST_UINT16Z_PTR;
#define FIT_UINT16Z_INVALID   (FIT_CAST(FIT_UINT16Z, 0x0000))
#define FIT_BASE_TYPE_UINT16Z (FIT_CAST(FIT_UINT8, 0x8B))

typedef uint32_t FIT_UINT32Z;
typedef const FIT_UINT32Z * FIT_CONST_UINT32Z_PTR;
#define FIT_UINT32Z_INVALID   (FIT_CAST(FIT_UINT32Z, 0x00000000))
#define FIT_BASE_TYPE_UINT32Z (FIT_CAST(FIT_UINT8, 0x8C))

typedef uint8_t FIT_BYTE;
typedef const FIT_BYTE * FIT_CONST_BYTE_PTR;
#define FIT_BYTE_INVALID   (FIT_CAST(FIT_BYTE, 0xFF)) // Field is invalid if all bytes are invalid.
#define FIT_BASE_TYPE_BYTE (FIT_CAST(FIT_UINT8, 0x0D))

typedef int64_t FIT_SINT64;
typedef const FIT_SINT64 * FIT_CONST_SINT64_PTR;
#define FIT_SINT64_INVALID   (FIT_CAST(FIT_SINT64, 0x7FFFFFFFFFFFFFFFL))
#define FIT_BASE_TYPE_SINT64 (FIT_CAST(FIT_UINT8, 0x8E))

typedef uint64_t FIT_UINT64;
typedef const FIT_UINT64 * FIT_CONST_UINT64_PTR;
#define FIT_UINT64_INVALID   (FIT_CAST(FIT_UINT64, 0xFFFFFFFFFFFFFFFFL))
#define FIT_BASE_TYPE_UINT64 (FIT_CAST(FIT_UINT8, 0x8F))

typedef uint64_t FIT_UINT64Z;
typedef const FIT_UINT64Z * FIT_CONST_UINT64Z_PTR;
#define FIT_UINT64Z_INVALID   (FIT_CAST(FIT_UINT64Z, 0x0000000000000000L))
#define FIT_BASE_TYPE_UINT64Z (FIT_CAST(FIT_UINT8, 0x90))

#define FIT_BASE_TYPES    17

typedef FIT_ENUM FIT_BOOL;
#define FIT_BOOL_INVALID      FIT_ENUM_INVALID
#define FIT_BOOL_FALSE        (FIT_CAST(FIT_BOOL, 0))
#define FIT_BOOL_TRUE         (FIT_CAST(FIT_BOOL, 1))
...
#define FIT_HDR_TIME_REC_BIT      (FIT_CAST(FIT_UINT8, 0x80))
#define FIT_HDR_TIME_TYPE_MASK    (FIT_CAST(FIT_UINT8, 0x60))
#define FIT_HDR_TIME_TYPE_SHIFT   5
#define FIT_HDR_TIME_OFFSET_MASK  (FIT_CAST(FIT_UINT8, 0x1F))
#define FIT_HDR_TYPE_DEF_BIT      (FIT_CAST(FIT_UINT8, 0x40))
#define FIT_HDR_DEV_DATA_BIT      (FIT_CAST(FIT_UINT8, 0x20))
#define FIT_HDR_TYPE_MASK         (FIT_CAST(FIT_UINT8, 0x0F))
...
#define FIT_MAX_MESG_SIZE         (FIT_CAST(FIT_UINT16, 65535))

#define FIT_ARCH_ENDIAN_MASK      (FIT_CAST(FIT_UINT8, 0x01))
...
#define FIT_MAX_FIELD_SIZE             (FIT_CAST(FIT_UINT8, 255))
#define FIT_FIELD_NUM_INVALID          (FIT_CAST(FIT_UINT8, 0xFF))
#define FIT_FIELD_NUM_MESSAGE_INDEX    (FIT_CAST(FIT_UINT8, 254))
#define FIT_FIELD_NUM_TIMESTAMP        (FIT_CAST(FIT_UINT8, 253))
#define FIT_FIELD_NUM_PART_NUMBER      (FIT_CAST(FIT_UINT8, 250))
...
#if defined(FIT_STRUCT_OFFSET_USE_STDDEF_OFFSETOF)
   #include <stddef.h>
   #define FIT_STRUCT_OFFSET(MEMBER, STRUCT_TYPE)                          offsetof(STRUCT_TYPE, MEMBER)
#else
   #if defined(__cplusplus)
      #ifndef _MSC_VER
         #warning "Define FIT_STRUCT_OFFSET_USE_STDDEF_OFFSETOF to prevent C Style Cast warning when using FIT_STRUCT_OFFSET"
      #endif
   #endif
