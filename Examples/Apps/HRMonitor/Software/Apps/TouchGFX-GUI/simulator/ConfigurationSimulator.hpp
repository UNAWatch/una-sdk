...
//GPS Sensor
#define GSP_SIM_ENABLE               0  // 0 - Disable
#define GSP_SIM_SPEED_MIN            25 // km/h
#define GPS_SIM_SPEED_BASE           30 // km/h
#define GPS_SIM_SPEED_MAX            35 // km/h
#define GPS_SIM_TIME_SEACH_SATELLITE 4 // seconds

//HeatRate Sensor
#define HEAT_RATE_SIM_ENABLE        1 // 0 - Disable
#define HEAT_RATE_SIM_MIN_HR        90 // Max - 255
#define HEAT_RATE_SIM_MAX_HR        140 // Max - 255
