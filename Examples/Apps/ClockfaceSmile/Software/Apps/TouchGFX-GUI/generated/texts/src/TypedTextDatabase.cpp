...
extern touchgfx::GeneratedFont& getFont_Poppins_SemiBold_16_2bpp();
extern touchgfx::GeneratedFont& getFont_Poppins_Medium_15_2bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_Poppins_SemiBold_60_2bpp()),
    &(getFont_Poppins_SemiBold_16_2bpp()),
    &(getFont_Poppins_Medium_15_2bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_Poppins_SemiBold_60_2bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_Poppins_SemiBold_16_2bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_Poppins_Medium_15_2bpp());
        break;
    }
}
} // namespace TypedTextDatabase
