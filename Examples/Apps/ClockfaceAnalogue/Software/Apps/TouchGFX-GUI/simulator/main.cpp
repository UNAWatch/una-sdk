...
// Sensor-layer request dispatcher. On target the kernel answers the service's
// sensor requests; in the simulator this thread stands in for it, and bringing
// up the simulated sensor layer is what gives the face a charge level to draw.
                       ...
                       char**                  argv)
{
    ...
    SDK::App::KernelMessageDispatcher kernelMessage(appComm, appComm.getMsgManager(),
                                                    vibro, backlight, buzzer);
